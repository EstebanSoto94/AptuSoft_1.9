// Desarrollado por PymeTec Ltda. para AptuSoft Ltda
// Type: Vortexerp.FacturaElectronica.Formularios.frmFacturaElectronica
// Assembly: Vortexerp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: DAAA0455-0600-4D01-B6F3-99A42B37B1DB
// Assembly location: C:\Documents and Settings\VORTEX\Escritorio\1.6.6\Vortexerp_Electronica.exe

using CrystalDecisions.CrystalReports.Engine;
using CrystalDecisions.Windows.Forms;
using Vortexerp;
using Vortexerp.DtsReportesTableAdapters;
using Vortexerp.FacturaElectronica;
using Vortexerp.FacturaElectronica.Clases;
using Vortexerp.FacturaElectronica.Clases.CreaXml;
using Vortexerp.FacturaElectronica.Clases.PDF417;
using Vortexerp.Lotes;
using Vortexerp.Properties;
using System;
...
namespace Vortexerp.FacturaElectronica.Formularios
{
  public class frmFacturaElectronica : Form
  {
       public Decimal totalOdepa;
      #region
    ...
    private void InitializeComponent()
    {
        ...
        this.CboValoresOdepa = new System.Windows.Forms.ComboBox();
        ...
        this.TxtOdepa = new System.Windows.Forms.TextBox();
        ...
        this.ticketTableAdapter1 = new Vortexerp.DtsReportesTableAdapters.TicketTableAdapter();
        this.ticketTableAdapter2 = new Vortexerp.DtsReportesTableAdapters.TicketTableAdapter();
        this.ticketTableAdapter3 = new Vortexerp.DtsReportesTableAdapters.TicketTableAdapter();
        this.ticketTableAdapter4 = new Vortexerp.DtsReportesTableAdapters.TicketTableAdapter();
        ...
        this.panelZonaDetalle.Controls.Add(this.CboValoresOdepa);
        ...
        // CboValoresOdepa
        // 
        this.CboValoresOdepa.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
        this.CboValoresOdepa.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
        this.CboValoresOdepa.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        this.CboValoresOdepa.FormattingEnabled = true;
        this.CboValoresOdepa.Location = new System.Drawing.Point(3, 18);
        this.CboValoresOdepa.Name = "CboValoresOdepa";
        this.CboValoresOdepa.Size = new System.Drawing.Size(92, 22);
        this.CboValoresOdepa.TabIndex = 47;
        // 
        ...
        this.dgvBuscaCliente.Location = new System.Drawing.Point(73, -117);
        ...
        this.pnlBuscaClienteDes.Location = new System.Drawing.Point(196, 224);
        ...
        this.btnImprime.Image = global::Vortexerp.Properties.Resources.imprimir_48;
        ...
        this.btnControlPago.Image = global::Vortexerp.Properties.Resources.pagar_48;
        ...
        this.btnGuardar.Image = global::Vortexerp.Properties.Resources.disquetes_excepto_icono_7120_48;
        ...
        this.btnSalir.Image = global::Vortexerp.Properties.Resources.salir_de_mi_perfil_icono_3964_48;
        ...
        this.btnModificar.Image = global::Vortexerp.Properties.Resources.modificar_48;
        ...
        this.btnEliminar.Image = global::Vortexerp.Properties.Resources.mark_correo_basura_icono_3897_48;
        ...
        this.btnLimpiar.Image = global::Vortexerp.Properties.Resources.cambio_de_cepillo_de_escoba_de_barrer_claro_icono_5768_48;
        ...
        // groupBox1
        // 
        this.groupBox1.Controls.Add(this.TxtOdepa);
        ...
        // TxtOdepa
        // 
        this.TxtOdepa.Location = new System.Drawing.Point(739, 23);
        this.TxtOdepa.Name = "TxtOdepa";
        this.TxtOdepa.Size = new System.Drawing.Size(100, 20);
        this.TxtOdepa.TabIndex = 44;
        this.TxtOdepa.Text = "0";
        // 
        // lblCodImp5
        // 
        ...
        // btnModificaLinea
        // 
        this.btnModificaLinea.Image = global::Vortexerp.Properties.Resources.modificalista_32;
        ...
        this.btnAgregar.Image = global::Vortexerp.Properties.Resources.construccion_de_anadir_icono_5620_32;
        ...
        // btnLimpiaDetalle
        // 
        this.btnLimpiaDetalle.Image = global::Vortexerp.Properties.Resources.construccion_de_eliminar_icono_9418_32;
        ...
        // btnComprobarFolio
        // 
        this.btnComprobarFolio.BackgroundImage = global::Vortexerp.Properties.Resources.comprobar_si_puede_icono_8214_48;
        ...
        this.cmbBodega.Location = new System.Drawing.Point(899, 31);
        ...
        // ticketTableAdapter3
        // 
        this.ticketTableAdapter3.ClearBeforeFill = true;
        // 
        // ticketTableAdapter4
        // 
        this.ticketTableAdapter4.ClearBeforeFill = true;
        // 
    ...
    public void agregaLineaGrilla()
    {
      ...
      Decimal Seleccion = Convert.ToDecimal(CboValoresOdepa.SelectedValue);
      //if (Seleccion > 0)
      //{
      //    totalOdepa = calculos.calculaOdepa(Seleccion, datosVentaVo.Cantidad);

      //    if (!(TxtOdepa.Text.Equals("")))
      //    {
      //        TxtOdepa.Text = (Convert.ToDecimal(TxtOdepa.Text) + Convert.ToDecimal(totalOdepa)).ToString("N0");
      //    }
      //    else
      //    {
      //        TxtOdepa.Text = "0";
    ...
    private void calculaTotales()
    {
      ...
      //if (!(TxtOdepa.Text.Equals("")))
      //    odepa = Convert.ToDecimal(TxtOdepa.Text);
      Decimal num5;
      ...
      this.txtTotalGeneral.Text = (/*odepa + */num6 + num7).ToString("N0");
      ...
      if (!this.impideVentaSinCredito)
      {
        ...
        if (!flag)
        {
          ...
          if (this.envioAutomaticoSii.Equals("1") && !this.chkHistoricoVentas.Checked && MessageBox.Show("¿ Desea Enviar el DTE a SII ?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
          {
            ...
            int num2 = (int) new frmEnviosSII("EFactura_" + folio.ToString("##") + "_envio.XML", ruta, new List<Venta>()
            {
              new Venta()
              {
                Folio = folio,
    ...
    private void creaXML(Venta ve, List<DatosVentaVO> listaDetalle)
    {
      ...
      this.armaCodigoPDF417("EFactura_" + ve.Folio.ToString("##"));
    }
    ...
    private void btnModificar_Click(object sender, EventArgs e)
    {
      ...
      if (dialogResult == DialogResult.Yes)
      {
        ...
        {
          string ruta = this._rutaElectronica + "DTE\\E-Factura\\";
          int num4 = (int) new frmEnviosSII("EFactura_" + num3.ToString("##") + "_envio.XML", ruta, new List<Venta>()
          {
            new Venta()
            {
              Folio = num3,
    ...
    private void buscaFacturaFolio()
    {
      this.panelFolio.Visible = false;
      EFactura efactura = new EFactura();
      Venta venta = efactura.buscaFacturaFolio(Convert.ToInt32(this.txtFolioBuscar.Text.Trim()));
    ...
    private void imprimeDirecto()
    {
        if (MessageBox.Show("Imprimir Factura Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
            ...
            reportDocument.Load("p:\\AptuSoft\\reportes\\FacturaElectronica.rpt");
        ...
        if (MessageBox.Show("Imprimir Copia Cedible de Factura Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
            ...
            DataTable dataTable = efactura.muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
            ReportDocument reportDocument = new ReportDocument();
            reportDocument.Load("p:\\AptuSoft\\reportes\\FacturaElectronicaCedible.rpt");
            reportDocument.SetDataSource(dataTable);
            //string str = new LeeXml().cargarDatos("factura");
            //reportDocument.PrintOptions.PrinterName = str;
            reportDocument.PrintToPrinter(1, false, 1, 1);
    ...
    private void creaPDF()
    {
      ...
      string nombre_archivo1 = "EFactura_" + this.txtNumeroDocumento.Text;
      int tipoDoc = 33;
      ...
      string nombre_archivo2 = "EFacturaCedible_" + this.txtNumeroDocumento.Text;
    ...
    private void multiEmpresa()
    {
      ...
      rpt1.Load("p:\\AptuSoft\\reportes\\FacturaElectronica_" + str + ".rpt");
      ...
      rpt2.Load("p:\\AptuSoft\\reportes\\FacturaElectronicaCedible_" + str + ".rpt");
    ...
    private void monoEmpresa()
    {
      DataTable dataTable = new EFactura().muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
      ReportDocument rpt1 = new ReportDocument();
      rpt1.Load("p:\\AptuSoft\\reportes\\FacturaElectronica.rpt");
      rpt1.SetDataSource(dataTable);
      int num1 = (int) new frmVisualizadorReportes(rpt1).ShowDialog();
      ReportDocument rpt2 = new ReportDocument();
      rpt2.Load("p:\\AptuSoft\\reportes\\FacturaElectronicaCedible.rpt");
      rpt2.SetDataSource(dataTable);
      int num2 = (int) new frmVisualizadorReportes(rpt2).ShowDialog();
      this._timbre = string.Empty;
      this.iniciaVenta();
    ...
    private void armaReferencia()
    {
      ...
      referenicaVo.FolioDocumentoReferencia = Convert.ToInt32(this.txtFolioDocumentoReferencia.Text);
    ...
    private decimal calcularOdepa(int valorodepa)
    {
        decimal cantidad = Convert.ToDecimal(this.txtCantidad.Text);
        decimal total;

        total = ((cantidad * valorodepa) * (5/100));
    ...
    private void cargarValoresOdepa()
    {
        CargaMaestros cargamaestros = new CargaMaestros();
        DataTable odepa = cargamaestros.cargaValoresOdepa();

        DataRow RowTodos = odepa.NewRow();
        RowTodos["nombre_cat"] = "NINGUNA";
        RowTodos["valor"] = "0";

        CboValoresOdepa.DataSource = odepa;
        CboValoresOdepa.DisplayMember = "nombre_cat";
        CboValoresOdepa.ValueMember = "valor";

        odepa.Rows.Add(RowTodos);
    }
