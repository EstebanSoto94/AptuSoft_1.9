...
// Type: Aptusoft.FacturaElectronica.Formularios.frmNotaDebitoElectronica
...
{
    public class frmNotaDebitoElectronica : Form
    {
        ...
        private frmNotaDebitoElectronica intance;
        ...
        public frmNotaDebitoElectronica()
        {
        ...
        private void cargaPermisos()
        {
            ...
            {
                if (usuarioVo.Modulo.Equals("E-NOTA DEBITO"))
                {
        ...
        {
            int folio = new ENotaDebito().numeroNotaDebito(this._caja);
            this.txtNumeroDocumento.Text = folio.ToString();
            if (this.chkHistoricoVentas.Checked)
                return;
            string archivoCaf = new Caf().archivoCaf(56, folio);
            bool flag = true;
            SubeXMLToDb sube = new SubeXMLToDb();
            sube.RecuperaCaf("56", @"\CAF\");
        ...
        {
            bool flag = false;
            if (File.Exists(this._rutaElectronica + "CAF\\E-NotaDebito\\" + archivoCaf))
                flag = true;
            return flag;
        }
        ...
        private void buscaCliente()
        {
            ...
            if (cli.Count > 1)
            {
                ...
                int num = (int)new frmClienteMismoRut(cli, ref this.intance, "nota_debito_electronica").ShowDialog();
            }
            else if (cli.Count == 0)
            {
        ...
        {
            int num = (int)new frmBuscaClientes(ref this.intance, "nota_debito_eletronica").ShowDialog();
        }
        ...
        private void guardaFactura()
        {
            ...
            bool flag = enotaDebito.NotaDebitoExiste(Convert.ToInt32(this.txtNumeroDocumento.Text.Trim()));
            if (flag)
            {
                ...
                this.txtNumeroDocumento.Enabled = false;
                Decimal aux = Decimal.Add(Convert.ToDecimal(enotaDebito.UltimoFolio()), 1);
            ...
            if (!flag)
            {
                ...
                enotaDebito.agregaNotaDebito(venta);
                enotaDebito.agregaDetalleNotaDebito(this.lista);
                if (this.listaReferencias.Count > 0)
                    enotaDebito.agregaReferencia(this.listaReferencias);
                ...
                SubeXMLToDb sube = new SubeXMLToDb();
                sube.Sube("NotaDebito_Electronica", venta.Folio.ToString(), @"DTE\\E-NotaDebito\\", "ENotaDebito_" + folio.ToString("##"));
                limpiar = true;
                ...
                {
                    string ruta = this._rutaElectronica + "DTE\\E-NotaDebito\\";
                    int num2 = (int)new frmEnviosSII("ENotaDebito_" + folio.ToString("##") + "_" + str + "_envio.XML", ruta, new List<Venta>()
          {
            new Venta()
            {
              Folio = folio,
        ...
        private void creaXML(Venta ve, List<DatosVentaVO> listaDetalle)
        {
            ...
            this.armaCodigoPDF417("ENotaDebito_" + ve.Folio.ToString("##") + "_" + str);
        }
        ...
        private void creaPDF()
        {
            try
            {
                ...
                {
                    archivoRpt = "NotaDebitoElectronica_" + str + ".rpt";
                }
                else
                {
                    archivoRpt = "NotaDebitoElectronica_" + str + ".rpt";
                }
                string nombre_archivo = "ENotaDebito_" + this.txtNumeroDocumento.Text + "_" + str;
                int tipoDoc = 56;
                DataTable dt = new ENotaDebito().muestraNotaDebitoFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
        ...
        private void armaCodigoPDF417(string documento)
        {
            try
            {
                XDocument xdocument = XDocument.Load(this._rutaElectronica + "DTE\\E-NotaDebito\\ENotaDebitoXML\\" + documento + ".XML", LoadOptions.PreserveWhitespace);
        ...
        private void imprimeFactura(int folio)
        {
            if (!this.chkHistoricoVentas.Checked)
            {
                //if (MessageBox.Show("Desea Imprimir la Nota de Debito?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                this.imprimeDirecto();
                //else
                //  this.iniciaVenta();
            }
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string text = enotaDebito.modificaNotaDebito(venta, this.lista);
                this.creaXML(venta, this.lista);
                if (MessageBox.Show("¿Desea Crear Archivo Pdf?", "Crear PDF", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                {
                    this.creaPDF();
                ...
                SubeXMLToDb sube = new SubeXMLToDb();
                if (sube.existe(num3.ToString("##"), "56"))
                {
                    sube.Sube("NotaDebito_Electronica", venta.Folio.ToString(), @"DTE\\E-NotaDebito\\", "ENotaDebito_" + num3.ToString("##"));
                }
                else
                {
                    sube.Actualizar("NotaDebito_Electronica", venta.Folio.ToString(), @"DTE\\E-NotaDebito\\", "ENotaDebito_" + num3.ToString("##"));
                }
                ...
                {
                    string ruta = this._rutaElectronica + "DTE\\E-NotaDebito\\";
                    int num4 = (int)new frmEnviosSII("ENotaDebito_" + num3.ToString("##") + "_" + str + "_envio.XML", ruta, new List<Venta>()
          {
            new Venta()
            {
              Folio = num3,
        ...
        private bool validaCampos()
        {
            ...
            {
                int num = (int)MessageBox.Show("Debe Ingresar Datos del Cliente", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                this.txtRut.Focus();
                return false;
            }
        ...
        private void frmFactura_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                this.txtCodigo.Focus();
                int num = (int)new frmBuscaProductos("nota_debito_electronica", ref this.intance, this.cmbBodega.Text.Trim(), Convert.ToInt32(this.cmbBodega.SelectedValue), this._modBodega, this.decimalesValoresVenta).ShowDialog();
                this.txtCantidad.Focus();
            }
        ...
        private void buscaNotaDebitoFolio()
        {
            this.panelFolio.Visible = false;
            ENotaDebito enotaDebito = new ENotaDebito();
            Venta venta = enotaDebito.buscaNotaDebitoFolio(Convert.ToInt32(this.txtFolioBuscar.Text.Trim()));
            ...
            if (venta.IdFactura != 0)
            {
                ...
                this.lista = enotaDebito.buscaDetalleNotaDebitoIDNotaDebito(venta.IdFactura);
                this.listaReferencias = enotaDebito.buscaReferenciaIDNotaDebito(venta.IdFactura);
            ...
            {
                int num = (int)MessageBox.Show("No Existe Nota de Debito Consultada!!", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                this.txtFolioBuscar.Clear();
                this.iniciaVenta();
            }
        }
            ...
            if (this.lblEstadoDocumento.Text.Equals("EMITIDA"))
            {
                if (MessageBox.Show("Esta seguro de Anular esta Factura. Los productos seran retornados a Bodega", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        int num = (int)MessageBox.Show(enotaDebito.anulaNotaDebito(this.idFactura, this.lista), "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        this.iniciaVenta();
                    }
                    catch (Exception ex)
                    {
        ...
        {
            if (MessageBox.Show("Esta seguro de Eliminar la Nota de Debito.", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ENotaDebito enotaDebito = new ENotaDebito();
                try
                {
                    enotaDebito.eliminaNotaDebito(this.idFactura, this.lista);
                    SubeXMLToDb sube = new SubeXMLToDb();
                    sube.eliminar("NotaDebito_Electronica", this.lista[0].FolioFactura.ToString());
                    int num = (int)MessageBox.Show("Nota de Debito electronica Eliminada", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                    this.iniciaVenta();
                }
                catch (Exception ex)
                {
            ...
            {
                int num = (int)MessageBox.Show("La Nota de Debito NO fue Eliminada ", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                this.iniciaVenta();
            }
        }
        ...
        {
            if (MessageBox.Show("Imprimir Nota de Debito Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ENotaDebito efactura = new ENotaDebito();
                DataTable dataTable = efactura.muestraNotaDebitoFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
                ReportDocument reportDocument = new ReportDocument();
                reportDocument.Load("C:\\AptuSoft\\reportes\\NotaDebitoElectronica_" + str + ".rpt");
        ...
        private void multiEmpresa()
        {
            ...
            DataTable dataTable = new ENotaDebito().muestraNotaDebitoFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
            ReportDocument rpt = new ReportDocument();
            rpt.Load("C:\\AptuSoft\\reportes\\NotaDebitoElectronica_" + str + ".rpt");
        ...
        private void txtFolioDocumentoReferencia_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                if (num1 == 61)
                    this.buscaNotaCreditoFolio(folio);
                if (num1 == 34)
        ...
        private void buscaNotaCreditoFolio(int folio)
        {
            this.panelFolio.Visible = false;
            ENotaCredito enotaCredito = new ENotaCredito();
            Venta venta = enotaCredito.buscaNotaCreditoFolio(folio);
            this.veOBFactura = venta;
            if (venta.IdFactura != 0)
            {
                ...
                textBox6.Text = str6;
                TextBox textBox7 = this.txtTotalExento;
            ...
            {
                int num1 = (int)MessageBox.Show("No Existe Nota de credito Consultada!!", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
        ...
        {
            this.armaCodigoPDF417Prueba("ENotaDebito_" + this.txtNumeroDocumento.Text);
        }

        private void armaCodigoPDF417Prueba(string documento)
        {
            try
            {
                XDocument xdocument = XDocument.Load(this._rutaElectronica + "DTE\\E-NotaDebito\\" + documento + ".XML", LoadOptions.PreserveWhitespace);
                xdocument.Declaration.Encoding = "ISO-8859-1";
                new XmlNamespaceManager((XmlNameTable)new NameTable()).AddNamespace("sii", "http://www.sii.cl/SiiDte");
                XElement xelement = System.Xml.XPath.Extensions.XPathSelectElement((XNode)xdocument, "DTE/Documento/TED");
                string str = xelement.ToString().Replace(Environment.NewLine, "");
                ...
                {
                    int num1 = (int)MessageBox.Show("Error al armar PDF417", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnComprobarFolio_Click(object sender, EventArgs e)
        {
            if (this.txtNumeroDocumento.Text.Trim().Length <= 0)
                return;
            string str = new Caf().archivoCaf(56, Convert.ToInt32(this.txtNumeroDocumento.Text));
            bool flag = true;
            if (str.Length == 0)
            {
                int num = (int)MessageBox.Show("No hay folios CAF disponibles, debe solicitar a SII y cargar en sistema", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Hand);
        ...
        private void InitializeComponent()
        {
            ...
            // btnBuscaCliente
            // 
            this.btnBuscaCliente.Location = new System.Drawing.Point(790, 8);
            ...
            this.label21.Location = new System.Drawing.Point(691, 53);
            ...
            this.txtDiasPlazo.Location = new System.Drawing.Point(783, 53);
            this.txtDiasPlazo.Name = "txtDiasPlazo";
            this.txtDiasPlazo.Size = new System.Drawing.Size(100, 13);
            this.txtDiasPlazo.TabIndex = 19;
            // 
            // txtContacto
            // 
            this.txtContacto.BackColor = System.Drawing.Color.White;
            this.txtContacto.Location = new System.Drawing.Point(60, 70);
            ...
            this.label11.Location = new System.Drawing.Point(279, 74);
            ...
            this.label10.Location = new System.Drawing.Point(467, 53);
            ...
            this.label8.Location = new System.Drawing.Point(665, 35);
            ...
            this.txtFax.Location = new System.Drawing.Point(313, 70);
            ...
            this.txtFono.Location = new System.Drawing.Point(519, 53);
            ...
            this.txtGiro.Location = new System.Drawing.Point(60, 53);
            this.txtGiro.Name = "txtGiro";
            this.txtGiro.Size = new System.Drawing.Size(401, 13);
            ...
            this.txtCiudad.Location = new System.Drawing.Point(707, 35);
            this.txtCiudad.Name = "txtCiudad";
            this.txtCiudad.Size = new System.Drawing.Size(176, 13);
            ...
            this.txtComuna.Location = new System.Drawing.Point(519, 35);
            ...
            this.txtDireccion.Location = new System.Drawing.Point(60, 35);
            this.txtDireccion.Name = "txtDireccion";
            this.txtDireccion.Size = new System.Drawing.Size(401, 13);
            ...
            this.btnAgregar.Location = new System.Drawing.Point(904, 173);
            ...
            this.btnLimpiaDetalle.Location = new System.Drawing.Point(904, 213);
            ...
            this.txtNumeroDocumento.Location = new System.Drawing.Point(794, 52);
            ...
            this.lblFolio.Location = new System.Drawing.Point(775, 33);
            this.lblFolio.Name = "lblFolio";
            this.lblFolio.Size = new System.Drawing.Size(126, 16);
            this.lblFolio.TabIndex = 5;
            this.lblFolio.Text = "E-Nota Debito N°";
            ...
            this.label3.Text = "NOTA DE DEBITO ELECTRONICA";
            ...
            this.lblEstadoDocumento.Location = new System.Drawing.Point(374, 14);
            ...
            // btnAnular
            // 
            this.btnAnular.Location = new System.Drawing.Point(992, 609);
            ...
            this.btnSalir.Location = new System.Drawing.Point(439, 58);
            ...
            this.cmbListaPrecio.ForeColor = System.Drawing.Color.Black;
            ...
            // txtTipoDescuento
            // 
            this.txtTipoDescuento.Location = new System.Drawing.Point(906, 537);
            this.txtTipoDescuento.Name = "txtTipoDescuento";
            this.txtTipoDescuento.Size = new System.Drawing.Size(29, 20);
            ...
            // txtSubTotalLinea
            // 
            this.txtSubTotalLinea.Location = new System.Drawing.Point(906, 514);
            this.txtSubTotalLinea.Name = "txtSubTotalLinea";
            this.txtSubTotalLinea.Size = new System.Drawing.Size(29, 20);
            ...
            this.btnModificaLinea.Location = new System.Drawing.Point(904, 253);
            ...
            // txtLinea
            // 
            this.txtLinea.Location = new System.Drawing.Point(906, 493);
            ...
            this.dgvBuscaCliente.Size = new System.Drawing.Size(637, 211);
            ...
            this.pnlBuscaClienteDes.Size = new System.Drawing.Size(650, 214);
            ...
            this.panelFolio.Location = new System.Drawing.Point(705, 73);
            this.panelFolio.Name = "panelFolio";
            this.panelFolio.Size = new System.Drawing.Size(230, 92);
            ...
            this.panel2.Controls.Add(this.txtTotalExento);
            this.panel2.Controls.Add(this.label13);
            this.panel2.Controls.Add(this.label14);
            this.panel2.Controls.Add(this.label15);
            this.panel2.Controls.Add(this.label17);
            this.panel2.Controls.Add(this.label19);
            this.panel2.Controls.Add(this.txtPorIva);
            this.panel2.Controls.Add(this.label20);
            this.panel2.Controls.Add(this.txtTotalDescuento);
            this.panel2.Controls.Add(this.txtSubTotal);
            this.panel2.Controls.Add(this.txtPorcDescuentoTotal);
            this.panel2.Controls.Add(this.txtNeto);
            this.panel2.Controls.Add(this.txtIva);
            this.panel2.Controls.Add(this.txtTotalGeneral);
            ...
            this.label17.Location = new System.Drawing.Point(73, 53);
            ...
            this.label19.Location = new System.Drawing.Point(77, 75);
            this.label19.Name = "label19";
            this.label19.Size = new System.Drawing.Size(31, 14);
            this.label19.TabIndex = 3;
            this.label19.Text = "I.V.A";
            // 
            // txtPorIva
            // 
            ...
            this.label20.Location = new System.Drawing.Point(65, 121);
            ...
            this.dgvReferencias.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgvReferencias_CellContentClick);
            // 
            // IdReferencia
            // 
            ...
            // button1
            // 
            this.button1.Location = new System.Drawing.Point(1005, 422);
            ...
            this.gbZonaOtros.Location = new System.Drawing.Point(229, 21);
            this.gbZonaOtros.Name = "gbZonaOtros";
            this.gbZonaOtros.Size = new System.Drawing.Size(441, 55);
            this.gbZonaOtros.TabIndex = 40;
            ...
            this.label36.Location = new System.Drawing.Point(701, 2);
            ...
            this.label45.Location = new System.Drawing.Point(172, 2);
            ...
            this.label37.Location = new System.Drawing.Point(797, 2);
            ...
            this.label48.Location = new System.Drawing.Point(734, 2);
            ...
            this.label38.Location = new System.Drawing.Point(259, 2);
            ...
            this.label47.Location = new System.Drawing.Point(644, 2);
            ...
            this.label46.Location = new System.Drawing.Point(581, 2);
            ...
            // chkHistoricoVentas
            // 
            this.chkHistoricoVentas.Location = new System.Drawing.Point(924, 79);
            this.chkHistoricoVentas.Name = "chkHistoricoVentas";
            this.chkHistoricoVentas.Size = new System.Drawing.Size(116, 52);
            this.chkHistoricoVentas.TabIndex = 48;
            this.chkHistoricoVentas.Text = "Nota de debito para historico de ventas";
            ...
            // btnCreaPdf
            // 
            this.btnCreaPdf.Location = new System.Drawing.Point(22, 638);
            this.btnCreaPdf.Name = "btnCreaPdf";
            this.btnCreaPdf.Size = new System.Drawing.Size(75, 23);
            this.btnCreaPdf.TabIndex = 49;
            ...
            this.Name = "frmNotaDebitoElectronica";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "56 - Nota de Debito Electronica";
        ...
        private void creaXMLCliente(Venta ve, List<DatosVentaVO> listaDetalle)
        {
            ...
            this.armaCodigoPDF417("ENotaDebito_" + ve.Folio.ToString("##") + "_" + str + "_envio_Contribuyente");
        ...
        private void envio(Venta ve)
        {
            ...
            {
            string str = new LeeXml().cargarDatosMultiEmpresa("factura")[1].ToString();
            string archivo = "ENotaDebito_" + ve.Folio.ToString("##") + "_" + str;
            string ruta_xml = this._rutaElectronica + @"DTE\E-NotaDebito\" + archivo + "_envio_Contribuyente.xml";
            string ruta_pdf = this._rutaElectronica + @"PDF\E-NotaDebito\" + archivo + ".pdf";
