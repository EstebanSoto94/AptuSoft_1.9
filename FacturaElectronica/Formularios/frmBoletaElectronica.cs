...
// Type: Aptusoft.FacturaElectronica.Formularios.frmBoletaElectronica
...
{
  public class frmBoletaElectronica : Form
  {
    ...
    private frmBoletaElectronica intance;
    ...
    public frmBoletaElectronica(string folio)
    {
      this.InitializeComponent();
      this.cargaPermisos();
      this.CargaRuta();
    ...
    public frmBoletaElectronica(string des, Decimal val)
    {
      this.InitializeComponent();
      this.cargaPermisos();
      this.CargaRuta();
    ...
    {
      int folio = new EBoleta().numeroBoleta(this._caja);
      this.txtNumeroDocumento.Text = folio.ToString();
      if (this.chkHistoricoVentas.Checked)
        return;
      SubeXMLToDb sube = new SubeXMLToDb();
      string archivoCaf = new Caf().archivoCaf(39, folio);
      sube.RecuperaCaf("39", @"\CAF\");
      bool flag = true;
    ...
    {
      bool flag = false;
      if (File.Exists(this._rutaElectronica + "CAF\\E-Boleta\\" + archivoCaf))
        flag = true;
      return flag;
    }
    ...
    private void calculaTotalLinea()
    {
        try
        {
            ...
            MessageBox.Show("verifique la entrada de datos");
            this.txtCantidad.Clear();
            this.txtPrecio.Clear();
        }
    }
    ...
    private void buscaCliente()
    {
      ...
      if (cli.Count > 1)
      {
        ...
        int num = (int) new frmClienteMismoRut(cli, ref this.intance, "boleta_electronica").ShowDialog();
      }
      else if (cli.Count == 0)
      {
    ...
    {
      int num = (int) new frmBuscaClientes(ref this.intance, "boleta_electronica").ShowDialog();
    }
    ...
    private void guardaFactura()
    {
      ...
      if (!this.impideVentaSinCredito)
      {
        ...
        bool flag = eboleta.boletaExiste(Convert.ToInt32(this.txtNumeroDocumento.Text.Trim()));
        if (flag)
        {
            ...
            this.txtNumeroDocumento.Enabled = false;
            Decimal aux = Decimal.Add(Convert.ToDecimal(eboleta.UltimoFolio()), 1);
        ...
        if (!flag)
        {
          ...
          eboleta.agregaBoleta(venta);
          eboleta.agregaDetalleFactura(this.lista, this._listaLote);
         this.creaXML(venta, this.lista);
          ...
          if (num1 == 1)
          {
            ...
            pvVO.Estado = "PAGADO";
            pvVO.TipoPago = "MP";
            int idDoc = eboleta.RetornaIdBoleta(venta.Folio);
            pagoVenta.agregarPagoVenta(pvVO, "BOLETA_ELECTRONICA", idDoc, venta.Folio, venta.FechaEmision);
          }
          ...
          {
            string ruta = this._rutaElectronica + "DTE\\E-Boleta\\";
            int num2 = (int) new frmEnviosSII("EBoleta_" + folio.ToString("##") + "_envio.XML", ruta, new List<Venta>()
            {
              new Venta()
              {
                Folio = folio,
    ...
    private void creaXML(Venta ve, List<DatosVentaVO> listaDetalle)
    {
      ...
      ve.Fe_IndServicio = 3;
      GeneradorXMLBoleta generadorXmlBoleta = new GeneradorXMLBoleta();
      int tipoDescuento = 0;
      ...
      generadorXmlBoleta.armaXML(ve, listaDetalle, tipoDescuento);
       string multi = new LeeXml().cargarDatosMultiEmpresa("factura")[1].ToString();
      this.armaCodigoPDF417("EBoleta_" + ve.Folio.ToString("##") + "_" + multi);
    }
    ...
    private void cambiaEstadoTicket()
    {
      ...
      string str = "BOLETA ELECTRONICA";
      this.veOBFactura.FolioDocumentoVenta = Convert.ToInt32(this.txtNumeroDocumento.Text.Trim());
      this.veOBFactura.IDDocumentoVenta = new EBoleta().RetornaIdBoleta(this.veOBFactura.FolioDocumentoVenta);
    ...
    {
      DialogResult dialogResult = MessageBox.Show("Esta Seguro de Modificar la Boleta ", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
      DateTime dateTime1 =DateTime.Now;
      // ISSUE: explicit reference operation
      // ISSUE: variable of a reference type
      DateTime local1 = @dateTime1;
      ...
      if (dialogResult == DialogResult.Yes)
      {
        ...
        if (venta.Total != this.veOBFactura.Total)
        {
          if (num1 == 1)
          {
            ...
            PagoVenta pagoVenta = new PagoVenta();
            PagoVentaVO pvVO = new PagoVentaVO();
            pagoVenta.eliminaPagoVenta("BOLETA_ELECTRONICA", this.idFactura, venta.Folio);
            pvVO.FechaCobro = venta.FechaEmision;
            pvVO.IdFormaPago = venta.IdMedioPago;
            pvVO.FormaPago = venta.MedioPago;
            pvVO.Monto = venta.Total;
            pvVO.Estado = "PAGADO";
            pvVO.TipoPago = "MP";
            pagoVenta.agregarPagoVenta(pvVO, "BOLETA_ELECTRONICA", this.idFactura, venta.Folio, venta.FechaEmision);
          }
          else
          {
            venta.EstadoPago = "PENDIENTE";
        ...
        string text = eboleta.modificaBoleta(venta, this.lista, this._listaLote, this._listaLoteAntigua);
        //this.creaXML(venta, this.lista);
        if (MessageBox.Show("¿Desea Crear Archivo Pdf?", "Crear PDF", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
        {
            this.creaPDF();
        ...
        //{
        //  string ruta = this._rutaElectronica + "DTE\\E-Boleta\\";
        //  int num4 = (int) new frmEnviosSII("EBoleta_" + num3.ToString("##") + "_envio.XML", ruta, new List<Venta>()
        //  {
        //    new Venta()
        //    {
        //      Folio = num3,
    ...
    private bool validaCampos()
    {
      ...
      if (this.lista.Count == 0)
      {
        int num = (int) MessageBox.Show("Debe Ingresar Datos", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        this.txtCodigo.Focus();
        return false;
      }
      if (!(Convert.ToDecimal(this.txtTotalGeneral.Text) <= new Decimal(0)))
        return true;
      int num1 = (int) MessageBox.Show("Debe Ingresar Dato", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
      this.txtCodigo.Focus();
      return false;
    }
    ...
    private void frmFactura_KeyDown(object sender, KeyEventArgs e)
    {
      ...
      {
        this.txtCodigo.Focus();
        int num = (int) new frmBuscaProductos("boleta_electronica", ref this.intance, this.cmbBodega.Text.Trim(), Convert.ToInt32(this.cmbBodega.SelectedValue), this._modBodega, this.decimalesValoresVenta).ShowDialog();
        this.txtCantidad.Focus();
      }
      ...
      {
        int num1 = (int) new frmVuelto(this.txtTotalGeneral.Text, ref this.intance, "boleta_electronica").ShowDialog();
      }
    ...
    private void buscaBoletaFolio()
    {
      ...
      try
      {
          venta = eboleta.buscaBoletaFolio(Convert.ToInt32(this.txtFolioBuscar.Text.Trim()));
      }
      catch
      {
          MessageBox.Show("Ingrese Solo Números","¡Advertencia!", MessageBoxButtons.OK,MessageBoxIcon.Warning);
          return;
      }
      ...
      if (venta.IdFactura != 0)
      {
        ...
        this.dgvDatosVenta.DataSource = (object) this.lista;
        this._listaLote.Clear();
        this._listaLote = new Lote().ListaLotePorDocumento("VENTA", "BOLETA ELECTRONICA", venta.IdFactura);
        this._listaLoteAntigua.Clear();
      ...
      {
        int num = (int) MessageBox.Show("No Existe Boleta Consultada!!", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        this.txtFolioBuscar.Clear();
        this.iniciaVenta();
      }
    }
    ...
    private void btnEliminar_Click(object sender, EventArgs e)
    {
      if (MessageBox.Show("Esta seguro de Eliminar esta Boleta.", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
      {
        ...
        try
        {
          eboleta.eliminaBoleta(this.idFactura, this.lista, this._listaLoteAntigua);
          if (this.hayTicket)
    ...
    private void imprimeDirecto()
    {
      try
      {
        ...
        //{
        //  int num = (int) new frmVisualizaPDF("EBoleta_" + this.txtNumeroDocumento.Text+"_"+multi, 39).ShowDialog();
        //  this.iniciaVenta();
        //}
        //else
        //{
        ...
        //  this.iniciaVenta();
          ...
          if (MessageBox.Show("Imprimir Boleta Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
          {
              ...
              reportDocument.Load("C:\\AptuSoft\\reportes\\BoletaElectronica_" + multi + ".rpt");
          ...
          //if (MessageBox.Show("Imprimir Copia Cedible de Boleta Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
          //{
          //    EFactura efactura = new EFactura();
          //    DataTable dataTable = efactura.muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
          //    ReportDocument reportDocument = new ReportDocument();
          //    reportDocument.Load("C:\\AptuSoft\\reportes\\BoletaElectronicaCedible_" + multi + ".rpt");
          //    reportDocument.SetDataSource(dataTable);
          //    //string str = new LeeXml().cargarDatos("factura");
          //    reportDocument.PrintOptions.PrinterName = impresora;
          //    reportDocument.PrintToPrinter(1, false, 1, 1);
    ...
    private void creaPDF()
    {
        try
        {
            ...
            {
                ArrayList arrayList = new ArrayList();
                archivoRpt = "BoletaElectronica_" + multi + ".rpt";
            }
            else
                archivoRpt = "BoletaElectronica_" + multi + ".rpt";
            string nombre_archivo = "EBoleta_" + this.txtNumeroDocumento.Text + "_" + multi;
            int tipoDoc = 39;
            DataTable dt = new EBoleta().muestraBoletaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
    ...
    {
        DataTable dataTable = new EBoleta().muestraBoletaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
        ReportDocument rpt1 = new ReportDocument();
        rpt1.Load("C:\\AptuSoft\\reportes\\BoletaElectronica_"+multi+".rpt");
        ...
        rpt2.Load("C:\\AptuSoft\\reportes\\BoletaElectronicaCedible_"+multi+".rpt");
    ...
    {
      int num = (int) new frmPagoVenta(ref this.intance, "BOLETA_ELECTRONICA", folio, codCli).ShowDialog();
      this.iniciaVenta();
    }
    ...
    {
      int num = (int) new frmVuelto(this.txtTotalGeneral.Text, ref this.intance, "BOLETA_ELECTRONICA").ShowDialog();
    }
    ...
    private bool reUsarFacturaFolio(int fol)
    {
      this.panelFolio.Visible = false;
      EBoleta eboleta = new EBoleta();
      Venta venta = eboleta.buscaBoletaFolio(fol);
      this.veOBFactura = venta;
      if (venta.IdFactura == 0)
        return false;
      if (venta.IdMedioPago != 0)
    ...
    {
      this.armaCodigoPDF417("EBoleta_" + this.txtNumeroDocumento.Text);
    }
    ...
    private void armaCodigoPDF417Respaldo(string documento)
    {
      try
      {
        XDocument xdocument = XDocument.Load(this._rutaElectronica + "DTE\\E-Boleta\\" + documento + ".XML", LoadOptions.PreserveWhitespace);
    ...
    private void armaCodigoPDF417(string documento)
    {
      try
      {
        XDocument xdocument = XDocument.Load(this._rutaElectronica + "DTE\\E-Boleta\\EBoletaXML\\" + documento + ".XML", LoadOptions.PreserveWhitespace);
        xdocument.Declaration.Encoding = "ISO-8859-1";
        new XmlNamespaceManager((XmlNameTable) new NameTable()).AddNamespace("sii", "http://www.sii.cl/SiiDte");
        XElement xelement = System.Xml.XPath.Extensions.XPathSelectElement((XNode) xdocument, "DTE/Documento/TED");
        string str = xelement.ToString().Replace(Environment.NewLine, "");
    ...
    private void btnComprobarFolio_Click(object sender, EventArgs e)
    {
      if (this.txtNumeroDocumento.Text.Trim().Length <= 0)
        return;
      string str = new Caf().archivoCaf(39, Convert.ToInt32(this.txtNumeroDocumento.Text));
      bool flag = true;
      if (str.Length == 0)
      {
        int num = (int) MessageBox.Show("No hay folios CAF disponibles, debe solicitar a SII y cargar en sistema", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Hand);
    ...
    private void cambiaEstadoNotaVentaMasiva(Venta ve)
    {
      if (!this.hayNotaVentaMasiva)
        return;
      ve.Facturada = true;
      ve.DocumentoVenta = "BOLETA ELECTRONICA";
      NotaVenta notaVenta = new NotaVenta();
      try
      {
      ...
      {
        int num = (int) MessageBox.Show("Error importar Notas de Venta: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
      }
    }
    ...
    private void InitializeComponent()
    {
            ...
            this.txtCreditoDisponible.Location = new System.Drawing.Point(643, 9);
            this.txtCreditoDisponible.Name = "txtCreditoDisponible";
            this.txtCreditoDisponible.ReadOnly = true;
            this.txtCreditoDisponible.Size = new System.Drawing.Size(73, 20);
            ...
            this.label38.Location = new System.Drawing.Point(597, 13);
            ...
            // btnBuscaCliente
            // 
            this.btnBuscaCliente.Location = new System.Drawing.Point(539, 8);
            this.btnBuscaCliente.Name = "btnBuscaCliente";
            this.btnBuscaCliente.Size = new System.Drawing.Size(50, 23);
            ...
            this.label21.Location = new System.Drawing.Point(540, 35);
            ...
            this.txtDiasPlazo.Location = new System.Drawing.Point(638, 35);
            ...
            this.txtContacto.Location = new System.Drawing.Point(62, 52);
            ...
            this.label10.Location = new System.Drawing.Point(357, 35);
            ...
            this.txtFax.Location = new System.Drawing.Point(316, 52);
            ...
            this.txtFono.Location = new System.Drawing.Point(394, 35);
            ...
            this.txtGiro.Location = new System.Drawing.Point(62, 35);
            ...
            this.txtCiudad.Location = new System.Drawing.Point(582, 18);
            ...
            this.txtComuna.Location = new System.Drawing.Point(394, 18);
            ...
            this.txtDireccion.Location = new System.Drawing.Point(62, 18);
            ...
            this.txtRazonSocial.Location = new System.Drawing.Point(195, 9);
            ...
            this.txtDigito.Location = new System.Drawing.Point(112, 9);
            ...
            this.txtRut.Location = new System.Drawing.Point(40, 9);
            ...
            this.lblFolio.Size = new System.Drawing.Size(102, 16);
            this.lblFolio.TabIndex = 5;
            this.lblFolio.Text = "E-BOLETA N°";
            ...
            this.label3.Text = "BOLETA ELECTRONICA";
            ...
            this.dgvDatosVenta.Location = new System.Drawing.Point(12, 166);
            ...
            this.dgvDatosVenta.Size = new System.Drawing.Size(888, 279);
            ...
            this.panelZonaDetalle.Location = new System.Drawing.Point(12, 120);
            ...
            this.dgvBuscaCliente.Size = new System.Drawing.Size(669, 211);
            ...
            this.pnlBuscaClienteDes.Location = new System.Drawing.Point(207, 103);
            this.pnlBuscaClienteDes.Name = "pnlBuscaClienteDes";
            this.pnlBuscaClienteDes.Size = new System.Drawing.Size(677, 214);
            ...
            this.panelFolio.Location = new System.Drawing.Point(693, 73);
            this.panelFolio.Name = "panelFolio";
            this.panelFolio.Size = new System.Drawing.Size(240, 92);
            ...
            // txtTicket
            // 
            this.txtTicket.Location = new System.Drawing.Point(61, 58);
            this.txtTicket.Name = "txtTicket";
            this.txtTicket.Size = new System.Drawing.Size(52, 20);
            ...
            this.gbZonaTicket.Size = new System.Drawing.Size(127, 95);
            this.gbZonaTicket.TabIndex = 34;
            this.gbZonaTicket.TabStop = false;
            // 
            // chkHistoricoVentas
            // 
            this.chkHistoricoVentas.Location = new System.Drawing.Point(905, 451);
            ...
            this.btnSalir.Location = new System.Drawing.Point(438, 58);
            ...
            this.pnlCotizacionBuscar.Size = new System.Drawing.Size(191, 110);
            ...
            this.panelNotaVenta.Location = new System.Drawing.Point(444, 129);
            this.panelNotaVenta.Name = "panelNotaVenta";
            this.panelNotaVenta.Size = new System.Drawing.Size(217, 106);
            ...
            this.btnVerificaCredito.Location = new System.Drawing.Point(721, 9);
            ...
            this.toolTip1.SetToolTip(this.btnVerificaCredito, "Verificar Credito del Cliente");
            ...
            this.panelZonaCliente.Size = new System.Drawing.Size(761, 37);
            this.panelZonaCliente.TabIndex = 42;
            // 
            // btnModificaLinea
            // 
            this.btnModificaLinea.Image = global::Aptusoft.Properties.Resources.modificalista_32;
            this.btnModificaLinea.Location = new System.Drawing.Point(903, 199);
            ...
            this.btnAgregar.Location = new System.Drawing.Point(903, 119);
            ...
            this.btnLimpiaDetalle.Location = new System.Drawing.Point(903, 159);
            ...
            this.panel4.Size = new System.Drawing.Size(763, 39);
            ...
            this.panel5.Controls.Add(this.txtFono);
            this.panel5.Controls.Add(this.label9);
            this.panel5.Controls.Add(this.label21);
            this.panel5.Controls.Add(this.txtGiro);
            this.panel5.Controls.Add(this.label10);
            this.panel5.Controls.Add(this.txtDiasPlazo);
            this.panel5.Controls.Add(this.txtCiudad);
            this.panel5.Controls.Add(this.txtFax);
            this.panel5.Controls.Add(this.txtContacto);
            this.panel5.Controls.Add(this.label11);
            this.panel5.Controls.Add(this.txtComuna);
            this.panel5.Controls.Add(this.label12);
            this.panel5.Location = new System.Drawing.Point(945, 321);
            this.panel5.Name = "panel5";
            this.panel5.Size = new System.Drawing.Size(181, 89);
            this.panel5.TabIndex = 47;
            this.panel5.Visible = false;
            // 
            // frmBoletaElectronica
            // 
            ...
            this.Name = "frmBoletaElectronica";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "39 - Boleta Electronica ";
