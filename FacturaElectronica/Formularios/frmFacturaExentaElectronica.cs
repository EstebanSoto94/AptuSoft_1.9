...
// Type: Aptusoft.FacturaElectronica.Formularios.frmFacturaExentaElectronica
...
{
  public class frmFacturaExentaElectronica : Form
  {
    ...
    private frmFacturaExentaElectronica intance;
    ...
    public frmFacturaExentaElectronica()
    {
    ...
    public frmFacturaExentaElectronica(string folio)
    {
      this.InitializeComponent();
      this.cargaPermisos();
      this.CargaRuta();
    ...
    private void cargaPermisos()
    {
      ...
      {
        if (usuarioVo.Modulo.Equals("E-FACTURA-EXENTA"))
        {
    ...
    {
      int folio = new EFacturaExenta().numeroFactura(this._caja);
      this.txtNumeroDocumento.Text = folio.ToString();
      if (this.chkHistoricoVentas.Checked)
        return;
      string archivoCaf = new Caf().archivoCaf(34, folio);
      bool flag = true;
    ...
    {
      bool flag = false;
      if (File.Exists(this._rutaElectronica + "CAF\\E-FacturaExenta\\" + archivoCaf))
        flag = true;
      return flag;
    }
    ...
    private void creaColumnasDetalle()
    {
      ...
      this.dgvDatosVenta.Columns[2].Width = 310;
    ...
    private void calculaTotalLinea()
    {
      ...
      if (subTotal == new Decimal(0) || subTotal > descuento)
      {
        ...
        Decimal num4 = Convert.ToDecimal(calculos.totalLinea(subTotal, descuento).ToString("N" + this.decimalesValoresVenta));
        this.txtTotalLinea.Text = num4.ToString("N0");
        this.netoLinea = num4;
      }
      else
      {
    ...
    private void buscaCliente()
    {
      ...
      if (cli.Count > 1)
      {
        ...
        int num = (int) new frmClienteMismoRut(cli, ref this.intance, "factura_exenta_electronica").ShowDialog();
      }
      else if (cli.Count == 0)
      {
    ...
    {
      int num = (int) new frmBuscaClientes(ref this.intance, "factura_exenta_electronica").ShowDialog();
    }
    ...
    private void guardaFactura()
    {
      ...
      venta.PorcentajeIva = new Decimal(0);
      venta.Total = Convert.ToDecimal(this.txtTotalGeneral.Text.Trim());
      venta.TotalExento = venta.Total;
      ...
      if (!this.impideVentaSinCredito)
      {
        ...
        bool flag = efacturaExenta.facturaExiste(Convert.ToInt32(this.txtNumeroDocumento.Text.Trim()));
        if (flag)
        {
          this.txtNumeroDocumento.Enabled = false;
          Decimal aux = Decimal.Add( Convert.ToDecimal( efacturaExenta.UltimoFolio()),1);
        ...
        if (!flag)
        {
          ...
          efacturaExenta.agregaFactura(venta);
          efacturaExenta.agregaDetalleFactura(this.lista);
          if (this.listaReferencias.Count > 0)
            efacturaExenta.agregaReferencia(this.listaReferencias);
          ...
          if (num1 == 1)
          {
            ...
            pvVO.Estado = "PAGADO";
            pvVO.TipoPago = "MP";
            int idDoc = efacturaExenta.RetornaIdFactura(venta.Folio);
            pagoVenta.agregarPagoVenta(pvVO, "FACTURA_EXENTA_ELECTRONICA", idDoc, venta.Folio, venta.FechaEmision);
          }
          int folio = Convert.ToInt32(this.txtNumeroDocumento.Text);
          int codCli = this.codigoCliente;
          SubeXMLToDb sube = new SubeXMLToDb();
          sube.Sube("Factura_electronica_exenta", venta.Folio.ToString(), @"\DTE\E-FacturaExenta\", "EFacturaExenta_" + folio.ToString("##"));
          limpiar = true;
          ...
          {
            string ruta = this._rutaElectronica + "DTE\\E-FacturaExenta\\";
            int num2 = (int) new frmEnviosSII("EFacturaExenta_" + folio.ToString("##") +"_"+multi+ "_envio.XML", ruta, new List<Venta>()
            {
              new Venta()
              {
                Folio = folio,
    ...
    private void creaXML(Venta ve, List<DatosVentaVO> listaDetalle)
    {
      ...
      this.armaCodigoPDF417("EFacturaExenta_" + ve.Folio.ToString("##"));
    }
      ...
      if (dialogResult == DialogResult.Yes)
      {
        ...
        if (venta.Total != this.veOBFactura.Total)
        {
          if (num1 == 1)
          {
            ...
            PagoVenta pagoVenta = new PagoVenta();
            PagoVentaVO pvVO = new PagoVentaVO();
            pagoVenta.eliminaPagoVenta("FACTURA_EXENTA_ELECTRONICA", this.idFactura, venta.Folio);
            pvVO.FechaCobro = venta.FechaEmision;
            pvVO.IdFormaPago = venta.IdMedioPago;
            pvVO.FormaPago = venta.MedioPago;
            pvVO.Monto = venta.Total;
            pvVO.Estado = "PAGADO";
            pvVO.TipoPago = "MP";
            pagoVenta.agregarPagoVenta(pvVO, "FACTURA_EXENTA_ELECTRONICA", this.idFactura, venta.Folio, venta.FechaEmision);
          }
          else
          {
            venta.EstadoPago = "PENDIENTE";
        ...
        string text = efacturaExenta.modificaFactura(venta, this.lista);
        this.creaXML(venta, this.lista);
        this.creaPDF();
        ...
        {
          string ruta = this._rutaElectronica + "DTE\\E-FacturaExenta\\";
          int num4 = (int) new frmEnviosSII("EFacturaExenta_" + num3.ToString("##") + "_envio.XML", ruta, new List<Venta>()
          {
            new Venta()
            {
              Folio = num3,
    ...
    private void txtTotalDescuento_TextChanged(object sender, EventArgs e)
    {
      ...
      {
        this.txtTotalGeneral.Text = Convert.ToDecimal(arrayList2[2].ToString()).ToString("N" + this.decimalesValoresVenta);
      }
      else
      {
    ...
    private void frmFactura_KeyDown(object sender, KeyEventArgs e)
    {
      ...
      {
        this.txtCodigo.Focus();
        int num = (int) new frmBuscaProductos("factura_exenta_electronica", ref this.intance, this.cmbBodega.Text.Trim(), Convert.ToInt32(this.cmbBodega.SelectedValue), this._modBodega, this.decimalesValoresVenta).ShowDialog();
        this.txtCantidad.Focus();
      }
    ...
    private void buscaFacturaFolio()
    {
      this.panelFolio.Visible = false;
      EFacturaExenta efacturaExenta = new EFacturaExenta();
      Venta venta = efacturaExenta.buscaFacturaFolio(Convert.ToInt32(this.txtFolioBuscar.Text.Trim()));
      ...
      if (venta.IdFactura != 0)
      {
        ...
        this.listaReferencias = efacturaExenta.buscaReferenciaIDFactura(venta.IdFactura);
      ...
      if (this.lblEstadoDocumento.Text.Equals("EMITIDA"))
      {
        if (MessageBox.Show("Esta seguro de Anular esta Factura. Los productos seran retornados a Bodega", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
          ...
          try
          {
            ...
            string text = efacturaExenta.anulaFactura(this.idFactura, this.lista);
            if (this.hayTicket)
    ...
    private void btnEliminar_Click(object sender, EventArgs e)
    {
      if (MessageBox.Show("Esta seguro de Eliminar esta Factura.", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
      {
        ...
        try
        {
          efacturaExenta.eliminaFactura(this.idFactura, this.lista);
          if (this.hayTicket)
            this.cambiaEstadoTicketEliminaFactura();
          if (this.hayGuia)
            this.cambiaEstadoGuiaEliminaFactura(this.veOBFactura);
    ...
    {
        if (MessageBox.Show("Imprimir Factura Exenta Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
            EFacturaExenta efactura = new EFacturaExenta();
            DataTable dataTable = efactura.muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
            ReportDocument reportDocument = new ReportDocument();
            reportDocument.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronica_"+multi+".rpt");
        ...
        if (MessageBox.Show("Imprimir Copia Cedible de la Factura Exenta Electronica", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
            EFacturaExenta efactura = new EFacturaExenta();
            DataTable dataTable = efactura.muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
            ReportDocument reportDocument = new ReportDocument();
            reportDocument.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronicaCedible_"+multi+".rpt");
            reportDocument.SetDataSource(dataTable);
            //string str = new LeeXml().cargarDatos("factura");
    ...
    private void creaPDF()
    {
        try
        {
            ...
            archivoRpt1 = "FacturaExentaElectronica_" + str + ".rpt";
            archivoRpt2 = "FacturaExentaElectronicaCedible_" + str + ".rpt";

            string nombre_archivo1 = "EFacturaExenta_" + this.txtNumeroDocumento.Text;
            int tipoDoc = 34;
            DataTable dt = new EFacturaExenta().muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
            csCreaPdf.creaPDF(archivoRpt1, nombre_archivo1, tipoDoc, dt);
            string nombre_archivo2 = "EFacturaExentaCedible_" + this.txtNumeroDocumento.Text;
    ...
    private void multiEmpresa()
    {
      ...
      arrayList2[0].ToString();
      string str = arrayList2[1].ToString();
      DataTable dataTable = new EFacturaExenta().muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
      ReportDocument rpt1 = new ReportDocument();
      rpt1.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronica_" + str + ".rpt");
      ...
      rpt2.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronicaCedible_" + str + ".rpt");
    ...
    private void monoEmpresa()
    {
      DataTable dataTable = new EFacturaExenta().muestraFacturaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
      ReportDocument rpt1 = new ReportDocument();
      rpt1.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronica_"+multi+".rpt");
      rpt1.SetDataSource(dataTable);
      int num1 = (int) new frmVisualizadorReportes(rpt1).ShowDialog();
      ReportDocument rpt2 = new ReportDocument();
      rpt2.Load("C:\\AptuSoft\\reportes\\FacturaExentaElectronicaCedible_"+multi+".rpt");
      rpt2.SetDataSource(dataTable);
      int num2 = (int) new frmVisualizadorReportes(rpt2).ShowDialog();
      this._timbre = string.Empty;
      this.iniciaVenta();
    ...
    {
      int num = (int) new frmPagoVenta(ref this.intance, "FACTURA_EXENTA_ELECTRONICA", folio, codCli).ShowDialog();
      this.iniciaVenta();
    }
    ...
    {
      int num = (int) new frmFacturaGuias(ref this.intance, "factura_exenta_electronica", "guias").ShowDialog();
    }
      ...
      try
      {
        ...
        if (venta.IdFactura != 0)
        {
          if (venta.IDDocumentoVenta == 0)
          {
            ...
            textBox6.Text = str6;
            this.hayCotizacion = true;
            TextBox textBox7 = this.txtObservaciones;
            string str7 = "Cotizacion N°: ";
            num1 = venta.Folio;
    ...
    private void cambiaEstadoNotaVenta()
    {
      ...
      this.veOBFactura.FolioDocumentoVenta = Convert.ToInt32(this.txtNumeroDocumento.Text.Trim());
      this.veOBFactura.IDDocumentoVenta = new EFacturaExenta().RetornaIdFactura(this.veOBFactura.FolioDocumentoVenta);
      this.veOBFactura.DocumentoVenta = str;
    ...
    private void cargaDocumentoReferencia()
    {
      ...
      this.cmbTipoDocumentoReferencia.SelectedValue = (object) 34;
    }
    ...
    private bool reUsarFacturaFolio(int fol)
    {
      this.panelFolio.Visible = false;
      EFacturaExenta efacturaExenta = new EFacturaExenta();
      Venta venta = efacturaExenta.buscaFacturaFolio(fol);
      this.veOBFactura = venta;
      if (venta.IdFactura == 0)
        return false;
      if (venta.IdMedioPago != 0)
    ...
    {
      this.armaCodigoPDF417("EFacturaExenta_" + this.txtNumeroDocumento.Text);
    }
    ...
    private void armaCodigoPDF417(string documento)
    {
      try
      {
        XDocument xdocument = XDocument.Load(this._rutaElectronica + "DTE\\E-FacturaExenta\\EFacturaExentaXML\\" + documento + ".XML", LoadOptions.PreserveWhitespace);
        xdocument.Declaration.Encoding = "ISO-8859-1";
        new XmlNamespaceManager((XmlNameTable) new NameTable()).AddNamespace("sii", "http://www.sii.cl/SiiDte");
        XElement xelement = System.Xml.XPath.Extensions.XPathSelectElement((XNode) xdocument, "DTE/Documento/TED");
        string str = xelement.ToString().Replace(Environment.NewLine, "");
    ...
    private void btnComprobarFolio_Click(object sender, EventArgs e)
    {
      if (this.txtNumeroDocumento.Text.Trim().Length <= 0)
        return;
      string str = new Caf().archivoCaf(34, Convert.ToInt32(this.txtNumeroDocumento.Text));
      bool flag = true;
      if (str.Length == 0)
      {
        int num = (int) MessageBox.Show("No hay folios CAF disponibles, debe solicitar a SII y cargar en sistema", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Hand);
    ...
    private void buscaGuiaFolio(int folioBuscar)
    {
      ...
      if (venta.IdFactura != 0)
      {
        if (!venta.Facturada)
        {
          ...
          textBox6.Text = str6;
          TextBox textBox7 = this.txtGuias;
          num1 = venta.Folio;
    ...
    private void InitializeComponent()
    {
            ...
            this.calculaVueltoTeclaF5ToolStripMenuItem.Visible = false;
            ...
            this.txtCodigo.Location = new System.Drawing.Point(172, 19);
            ...
            this.lblFolio.Size = new System.Drawing.Size(146, 16);
            this.lblFolio.TabIndex = 5;
            this.lblFolio.Text = "E-Factura Exenta N°";
            ...
            this.label3.Text = "FACTURA EXENTA ELECTRONICA";
            ...
            this.lblEstadoDocumento.Location = new System.Drawing.Point(391, 15);
            ...
            this.txtTotalGeneral.Location = new System.Drawing.Point(112, 50);
            ...
            this.label26.Location = new System.Drawing.Point(65, 54);
            ...
            this.pnlBuscaClienteDes.Size = new System.Drawing.Size(640, 214);
            ...
            this.gbZonaTicket.Size = new System.Drawing.Size(168, 150);
            ...
            this.btnComprobarFolio.Location = new System.Drawing.Point(961, 46);
            ...
            this.Name = "frmFacturaExentaElectronica";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "34 - Factura No Afecta o Exenta Electronica";
