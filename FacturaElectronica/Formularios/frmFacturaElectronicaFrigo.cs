...
{
  public class frmFacturaElectronicaFrigo : Form
  {
    ...
    private frmFacturaElectronicaFrigo intance;
    ...
    public frmFacturaElectronicaFrigo()
    {
    ...
    public frmFacturaElectronicaFrigo(string folio)
    {
      this.InitializeComponent();
      this.cargaPermisos();
      this.cargaOpcionesDocumentosInicio();
    ...
    public frmFacturaElectronicaFrigo(string des, Decimal val)
    {
      this.InitializeComponent();
      this.cargaPermisos();
      this.cargaOpcionesDocumentosInicio();
    ...
    private void InitializeComponent()
    {
            ...
            this.cmbBodega.Location = new System.Drawing.Point(903, 368);
            ...
            this.panelZonaDetalle.Controls.Add(this.label45);
            ...
            this.label28.Location = new System.Drawing.Point(903, 342);
            ...
            this.label45.Location = new System.Drawing.Point(2, 1);
            this.label45.Name = "label45";
            this.label45.Size = new System.Drawing.Size(92, 23);
            this.label45.TabIndex = 47;
            this.label45.Text = "Categoría";
            // 
            // CboValoresOdepa
            // 
            ...
            this.CboValoresOdepa.Location = new System.Drawing.Point(3, 20);
            this.CboValoresOdepa.Name = "CboValoresOdepa";
            this.CboValoresOdepa.Size = new System.Drawing.Size(91, 21);
            this.CboValoresOdepa.TabIndex = 48;
            // 
    ...
    public void agregaLineaGrilla()
    {
      ...
      datosVentaVo.Descripcion = this.txtDescripcion.Text.Trim() + " (" + this.CboValoresOdepa.Text.ToString()+ ")";
      ...
      datosVentaVo.CatCarne = CboValoresOdepa.Text.ToString();
      if (this.idImpuesto > 0)
      {
          if (this.idImpuesto == 1)
    ...
    private void calculaTotales()
    {
      ...
      string str1 = num5.ToString("N0");
      textBox1.Text = str1;
      TextBox textBox2 = this.txtIva;
      num5 = calculos.totalIva(neto);
      string str2 = num5.ToString("N0");
      textBox2.Text = str2;
    ...
    private void buscaCliente()
    {
      ...
      if (cli.Count > 1)
      {
        ...
        int num = (int) new frmClienteMismoRut(cli, ref this.intance, "factura_electronica_frigo").ShowDialog();
      }
      else if (cli.Count == 0)
      {
    ...
    {
      int num = (int) new frmBuscaClientes(ref this.intance, "factura_electronica_frigo").ShowDialog();
    }
    ...
    private void frmFactura_KeyDown(object sender, KeyEventArgs e)
    {
      ...
      {
        this.txtCodigo.Focus();
        int num = (int) new frmBuscaProductos("factura_electronica_frigo", ref this.intance, this.cmbBodega.Text.Trim(), Convert.ToInt32(this.cmbBodega.SelectedValue), this._modBodega, this.decimalesValoresVenta).ShowDialog();
        this.txtCantidad.Focus();
      }
      ...
      {
        int num1 = (int) new frmVuelto(this.txtTotalGeneral.Text, ref this.intance, "factura_electronica_frigo").ShowDialog();
      }
    ...
    {
      int num = (int) new frmPagoVenta(ref this.intance, "FACTURA_ELECTRONICA_FRIGO", folio, codCli).ShowDialog();
      this.iniciaVenta();
    }
    ...
    {
      int num = (int) new frmFacturaGuias(ref this.intance, "factura_electronica_frigo", "guias").ShowDialog();
    }
    ...
    {
      int num = (int) new frmFacturaGuias(ref this.intance, "factura_electronica_frigo", "nota_de_venta").ShowDialog();
    }
    ...
    private void cargarValoresOdepa()
    {
        ...
        try
        {
            CboValoresOdepa.SelectedValue = "0";
        }
        catch { CboValoresOdepa.SelectedIndex = 1; }
    }
