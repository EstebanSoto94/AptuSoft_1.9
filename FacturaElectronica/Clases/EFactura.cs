...
namespace Aptusoft.FacturaElectronica.Clases
{
  public class EFactura
  {
    ...
    public bool agregaDetalleFactura2(DatosVentaVO veVO)
    {
      ...
      try
      {
        ((DbCommand) command).CommandText = "INSERT INTO electronica_detalle_factura (\r\n                                                            idFacturaLinea,\r\n                                                            folioFactura,\r\n                                                            fechaIngreso,\r\n                                                            codigo,\r\n                                                            descripcion,\r\n                                                            valorVenta,\r\n                                                            cantidad,\r\n                                                            porcentajeDescuentoLinea,\r\n                                                            descuentoLinea,\r\n                                                            subtotalLinea,\r\n                                                            totalLinea,\r\n                                                            tipoDescuento,\r\n                                                            listaPrecio,\r\n                                                            bodega,\r\n                                                            idImpuesto,\r\n                                                            netoLinea,\r\n                                                            descuentaInventario,\r\n                                                            valorCompra,\r\n                                                            usuario,\r\n                                                            stockQueda, exento\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactuLinea,\r\n                                                            @folioFacturaLinea,\r\n                                                            @fechaIngreso,\r\n                                                            @codigo,\r\n                                                            @descripcion,\r\n                                                            @valorVenta,\r\n                                                            @cantidad,\r\n                                                            @porcentajeDescuentoLinea,\r\n                                                            @descuentoLinea,\r\n                                                            @subtotalLinea,\r\n                                                            @totalLinea,\r\n                                                            @tipoDescuento,\r\n                                                            @listaPrecio,\r\n                                                            @bodega,\r\n                                                            @idImpuesto,\r\n                                                            @netoLinea,\r\n                                                            @descuentaInventario,\r\n                                                            @valorCompra,\r\n                                                            @usuario,\r\n                                                            @stockQueda, @exento\r\n                                                             )";
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "INSERT INTO electronica_factura_referencias (\r\n                                                            idFactura,\r\n                                                            folioFactura,\r\n                                                            tipoDocumento,\r\n                                                            tipoDocumentoNombre,\r\n                                                            folioDocumentoReferencia,\r\n                                                            fechaDocumentoReferencia,\r\n                                                            tipoAccion,\r\n                                                            tipoAccionNombre,\r\n                                                            razonReferencia\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactura,\r\n                                                            @folioFactura,\r\n                                                            @tipoDocumento,\r\n                                                            @tipoDocumentoNombre,\r\n                                                            @folioDocumentoReferencia,\r\n                                                            @fechaDocumentoReferencia,\r\n                                                            @tipoAccion,\r\n                                                            @tipoAccionNombre,\r\n                                                            @razonReferencia\r\n                                                             )";
    ...
    public List<DatosVentaVO> buscaDetalleFacturaIDFactura(int idFactura)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idDetalleFactura, \r\n                                                    idFacturaLinea,\r\n                                                    folioFactura,\r\n                                                    fechaIngreso,\r\n                                                    codigo,\r\n                                                    descripcion,\r\n                                                    valorVenta,\r\n                                                    cantidad,\r\n                                                    porcentajeDescuentoLinea,\r\n                                                    descuentoLinea,\r\n                                                    subtotalLinea,\r\n                                                    totalLinea,\r\n                                                    tipoDescuento,\r\n                                                    listaPrecio,\r\n                                                    bodega,\r\n                                                    idImpuesto,\r\n                                                    netoLinea,\r\n                                                    descuentaInventario,\r\n                                                    valorCompra,stockQueda, exento\r\n                                                    FROM electronica_detalle_factura WHERE idFacturaLinea = @idFactura ORDER BY idDetalleFactura asc";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
