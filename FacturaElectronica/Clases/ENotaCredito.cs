...
// Type: Aptusoft.FacturaElectronica.Clases.ENotaCredito
...
namespace Aptusoft.FacturaElectronica.Clases
{
  public class ENotaCredito
  {
    ...
    public string UltimoFolio()
    {
        string ultimo = "";
        MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
        ((DbCommand)command).CommandText = "select last_insert_id(folio) as last from electronica_nota_credito order by folio desc limit 1;";
    ...
    public void agregaDetalleNotaCredito(List<DatosVentaVO> lista, List<LoteVO> listaLote)
    {
      ...
      if (listaLote.Count <= 0)
        return;
      string str = "NOTA DE CREDITO ELECTRONICA";
    ...
    public bool agregaDetalleNotaCredito2(DatosVentaVO veVO)
    {
      ...
      try
      {
        ((DbCommand) command).CommandText = "INSERT INTO electronica_detalle_nota_credito (\r\n                                                            idNotaCreditoLinea,\r\n                                                            folioNotaCredito,\r\n                                                            fechaIngreso,\r\n                                                            codigo,\r\n                                                            descripcion,\r\n                                                            valorVenta,\r\n                                                            cantidad,\r\n                                                            porcentajeDescuentoLinea,\r\n                                                            descuentoLinea,\r\n                                                            subtotalLinea,\r\n                                                            totalLinea,\r\n                                                            tipoDescuento,\r\n                                                            listaPrecio,\r\n                                                            bodega,\r\n                                                            idImpuesto,\r\n                                                            netoLinea,\r\n                                                            descuentaInventario,\r\n                                                            valorCompra,\r\n                                                            usuario,\r\n                                                            stockQueda, exento\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactuLinea,\r\n                                                            @folioFacturaLinea,\r\n                                                            @fechaIngreso,\r\n                                                            @codigo,\r\n                                                            @descripcion,\r\n                                                            @valorVenta,\r\n                                                            @cantidad,\r\n                                                            @porcentajeDescuentoLinea,\r\n                                                            @descuentoLinea,\r\n                                                            @subtotalLinea,\r\n                                                            @totalLinea,\r\n                                                            @tipoDescuento,\r\n                                                            @listaPrecio,\r\n                                                            @bodega,\r\n                                                            @idImpuesto,\r\n                                                            @netoLinea,\r\n                                                            @descuentaInventario,\r\n                                                            @valorCompra,\r\n                                                            @usuario,\r\n                                                            @stockQueda, @exento\r\n                                                             )";
    ...
    {
      int num = this.RetornaIdNotaCredito(listaReferencia[0].FolioDocumento);
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "INSERT INTO electronica_nota_credito_referencias (\r\n                                                            idNotaCredito,\r\n                                                            folioNotaCredito,\r\n                                                            tipoDocumento,\r\n                                                            tipoDocumentoNombre,\r\n                                                            folioDocumentoReferencia,\r\n                                                            fechaDocumentoReferencia,\r\n                                                            tipoAccion,\r\n                                                            tipoAccionNombre,\r\n                                                            razonReferencia\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idNotaCredito,\r\n                                                            @folioNotaCredito,\r\n                                                            @tipoDocumento,\r\n                                                            @tipoDocumentoNombre,\r\n                                                            @folioDocumentoReferencia,\r\n                                                            @fechaDocumentoReferencia,\r\n                                                            @tipoAccion,\r\n                                                            @tipoAccionNombre,\r\n                                                            @razonReferencia\r\n                                                             )";
      command.Parameters.AddWithValue("@idNotaCredito", (object) refe.idDocumento);
      command.Parameters.AddWithValue("@folioNotaCredito", (object) refe.FolioDocumento);
    ...
    public List<ReferenicaVO> buscaReferenciaIDNotaCredito(int idFactura)
    {
      List<ReferenicaVO> list = new List<ReferenicaVO>();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idReferencia, idNotaCredito,\r\n                                                            folioNotaCredito,\r\n                                                            tipoDocumento,\r\n                                                            tipoDocumentoNombre,\r\n                                                            folioDocumentoReferencia,\r\n                                                            fechaDocumentoReferencia,\r\n                                                            tipoAccion,\r\n                                                            tipoAccionNombre,\r\n                                                            razonReferencia\r\n                                                    FROM electronica_nota_credito_referencias WHERE idNotaCredito = @idNotaCredito ORDER BY idReferencia asc";
      command.Parameters.AddWithValue("@idNotaCredito", (object) idFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
        list.Add(new ReferenicaVO()
        {
          IdReferencia = Convert.ToInt32(((DbDataReader) mySqlDataReader)["idReferencia"].ToString()),
          idDocumento = Convert.ToInt32(((DbDataReader) mySqlDataReader)["idNotaCredito"].ToString()),
          FolioDocumento = Convert.ToInt32(((DbDataReader) mySqlDataReader)["folioNotaCredito"].ToString()),
    ...
    public bool NotaCreditoExiste(int numFactura)
    {
      bool flag = false;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT folio FROM electronica_nota_credito WHERE folio=@numFactura";
    ...
    public int RetornaIdNotaCredito(int numFactura)
    {
      int num = 0;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idNotaCredito, folio FROM electronica_nota_credito WHERE folio=@numFactura";
      command.Parameters.AddWithValue("@numFactura", (object) numFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
    ...
    public Venta buscaNotaCreditoFolio(int numFactura)
    {
      Venta venta = new Venta();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idNotaCredito,\r\n                                                            folio,\r\n                                                            fechaEmision,\r\n                                                            fechaVencimiento,\r\n                                                            idCliente,\r\n                                                            rut,\r\n                                                            digito,\r\n                                                            razonSocial,\r\n                                                            direccion,\r\n                                                            comuna,\r\n                                                            ciudad,\r\n                                                            giro,\r\n                                                            fono,\r\n                                                            fax, \r\n                                                            contacto,\r\n                                                            diasPlazo,\r\n                                                            idMedioPago,\r\n                                                            medioPago,\r\n                                                            idVendedor,\r\n                                                            vendedor,\r\n                                                            idCentroCosto,\r\n                                                            centroCosto,\r\n                                                            ordenCompra,\r\n                                                            subtotal,\r\n                                                            porcentajeDescuento, \r\n                                                            descuento,\r\n                                                            porcentajeIva,\r\n                                                            iva,\r\n                                                            neto,\r\n                                                            total, totalExento,\r\n                                                            totalPalabras,\r\n                                                            estadoPago,\r\n                                                            estadoDocumento,\r\n                                                            totalPagado,\r\n                                                            totalDocumentado,\r\n                                                            totalPendiente,\r\n                                                            impuesto1,\r\n                                                            impuesto2,\r\n                                                            impuesto3,\r\n                                                            impuesto4,\r\n                                                            impuesto5,\r\n                                                            porcentajeImpuesto1,\r\n                                                            porcentajeImpuesto2,\r\n                                                            porcentajeImpuesto3,\r\n                                                            porcentajeImpuesto4,\r\n                                                            porcentajeImpuesto5,\r\n                                                            idTicket,\r\n                                                            folioTicket,\r\n                                                            folioGuias,\r\n                                                            observaciones,\r\n                                                            idCotizacion,\r\n                                                            folioCotizacion,\r\n                                                            idNotaVenta,\r\n                                                            folioNotaVenta,\r\n                                                            folioOT, \r\n                                                            timbre,\r\n                                                            enviado_sii,\r\n                                                            enviado_libro,\r\n                                                            codImpuesto1,\r\n                                                            codImpuesto2,\r\n                                                            codImpuesto3,\r\n                                                            codImpuesto4,\r\n                                                            codImpuesto5      \r\n                                                FROM electronica_nota_credito WHERE folio=@numFactura";
      command.Parameters.AddWithValue("@numFactura", (object) numFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
      {
    ...
    public List<DatosVentaVO> buscaDetalleNotaCreditoIDNotaCredito(int idFactura)
    {
      List<DatosVentaVO> list = new List<DatosVentaVO>();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idDetalleNotaCredito, \r\n                                                    idNotaCreditoLinea,\r\n                                                    folioNotaCredito,\r\n                                                    fechaIngreso,\r\n                                                    codigo,\r\n                                                    descripcion,\r\n                                                    valorVenta,\r\n                                                    cantidad,\r\n                                                    porcentajeDescuentoLinea,\r\n                                                    descuentoLinea,\r\n                                                    subtotalLinea,\r\n                                                    totalLinea,\r\n                                                    tipoDescuento,\r\n                                                    listaPrecio,\r\n                                                    bodega,\r\n                                                    idImpuesto,\r\n                                                    netoLinea,\r\n                                                    descuentaInventario,\r\n                                                    valorCompra,stockQueda, exento\r\n                                                    FROM electronica_detalle_nota_credito WHERE idNotaCreditoLinea = @idFactura ORDER BY idDetalleNotaCredito asc";
    ...
    public int numeroNotaCredito(int caja)
    {
      int num = 0;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand)command).CommandText = "SELECT MAX(folio)+1 FROM electronica_nota_credito;";
    ...
    public string modificaNotaCredito(Venta veOB, List<DatosVentaVO> listaNueva, List<LoteVO> listaLote, List<LoteVO> listaLoteAntigua)
    {
      ...
      try
      {
        ...
        {
          new ControlProducto().registroDocumentoModifica(datosVentaVo, "NOTA CREDITO ELECTRONICA");
          new ControlProducto().registroDocumentoModificaRetornaInventario(datosVentaVo, "NOTA CREDITO ELECTRONICA");
        ...
        return "Nota de Credito Electronica Modificada";
      }
      catch (Exception ex)
      {
    ...
    public bool eliminaDetalleNotaCredito(Venta veOB)
    {
      ...
      try
      {
        ((DbCommand) command).CommandText = "DELETE FROM electronica_detalle_nota_credito WHERE idNotaCreditoLinea=@idFactura AND folioNotaCredito=@folioFactura";
        command.Parameters.AddWithValue("@idFactura", (object) veOB.IdFactura);
    ...
    public int eliminaNotaCredito(int idFactura, List<DatosVentaVO> lista, List<LoteVO> listaLoteAntigua)
    {
      foreach (DatosVentaVO datosVentaVo in lista)
      {
        if (datosVentaVo.DescuentaInventario)
        {
          new ControlProducto().registroDocumentoNulo(datosVentaVo, "NOTA CREDITO ELECTRONICA");
          this.actualizaStock(datosVentaVo, "-");
        }
      }
      if (listaLoteAntigua.Count > 0)
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "DELETE electronica_nota_credito, electronica_detalle_nota_credito FROM electronica_nota_credito, electronica_detalle_nota_credito WHERE electronica_nota_credito.idNotaCredito = @idFactura AND electronica_detalle_nota_credito.idNotaCreditoLinea=@idFactura";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
      return ((DbCommand) command).ExecuteNonQuery();
    }

    public string anulaNotaCredito(int idFactura, List<DatosVentaVO> lista)
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "UPDATE electronica_nota_credito SET estadoDocumento = 'ANULADA', razonSocial= 'FACTURA ANULADA', rut='0', digito='0', subtotal='0', descuento='0', neto='0', iva='0',  total='0', impuesto1='0', impuesto2='0',impuesto3='0',impuesto4='0',impuesto5='0'  WHERE idNotaCredito=@idFactura";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
      ((DbCommand) command).ExecuteNonQuery();
      foreach (DatosVentaVO datosVentaVo in lista)
      {
      ...
      return "Nota Credito Electronica Anulada!!";
    }
    ...
    public DataTable notaCreditoElectronicaInforme(string filtro)
    {
      string str = "SELECT\r\n                                        idNotaCredito,\r\n                                        folio,\r\n                                        fechaEmision,\r\n                                        fechaVencimiento,\r\n                                        idCliente,\r\n                                        rut,\r\n                                        digito,\r\n                                        razonSocial,\r\n                                        direccion,\r\n                                        comuna,\r\n                                        ciudad,\r\n                                        giro,\r\n                                        fono,\r\n                                        fax,\r\n                                        contacto,\r\n                                        diasPlazo,\r\n                                        idMedioPago,\r\n                                        medioPago,\r\n                                        idVendedor,\r\n                                        vendedor,\r\n                                        idCentroCosto,\r\n                                        centroCosto,\r\n                                        ordenCompra,\r\n                                        subtotal,\r\n                                        porcentajeDescuento,\r\n                                        descuento,\r\n                                        porcentajeIva,\r\n                                        iva,\r\n                                        neto,\r\n                                        total,\r\n                                        totalPalabras,\r\n                                        estadoPago,\r\n                                        estadoDocumento,\r\n                                        totalPagado,\r\n                                        totalDocumentado,\r\n                                        totalPendiente,\r\n                                        impuesto1,\r\n                                        impuesto2,\r\n                                        impuesto3,\r\n                                        impuesto4,\r\n                                        impuesto5,\r\n                                        porcentajeImpuesto2,\r\n                                        porcentajeImpuesto1,\r\n                                        porcentajeImpuesto3,\r\n                                        porcentajeImpuesto4,\r\n                                        porcentajeImpuesto5,\r\n                                        comisionVendedor,\r\n                                        idTicket,\r\n                                        folioTicket,\r\n                                        folioGuias,\r\n                                        observaciones,\r\n                                        fechaModificacion,\r\n                                        idCotizacion,\r\n                                        folioCotizacion,\r\n                                        caja,\r\n                                        idNotaVenta,\r\n                                        folioNotaVenta                                        \r\n                                FROM\r\n                                electronica_nota_credito\r\n                                WHERE " + filtro + " ORDER BY folio";
      DataTable dataTable = new DataTable();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = str;
      ((DbDataAdapter) new MySqlDataAdapter(command)).Fill(dataTable);
    ...
    public List<Venta> buscaNotaCreditoPago(int idCliente, List<Venta> lisVen)
    {
      Venta venta = new Venta();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ...
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
        lisVen.Add(new Venta()
        {
          TipoNotaCredito = "NOTA CREDITO ELECTRONICA",
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "UPDATE electronica_nota_credito SET montoUsado = (@montoUsado + montoUsado)                                                          \r\n                                           WHERE folio=@folio";
      command.Parameters.AddWithValue("@folio", (object) folio);
