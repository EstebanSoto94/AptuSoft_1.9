...
// Type: Aptusoft.FacturaElectronica.Clases.EFacturaExenta
...
namespace Aptusoft.FacturaElectronica.Clases
{
  public class EFacturaExenta
  {
    ...
    public void agregaDetalleFactura(List<DatosVentaVO> lista)
    {
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      int num = this.RetornaIdFactura(veVO.FolioFactura);
      try
      {
        ((DbCommand) command).CommandText = "INSERT INTO electronica_detalle_factura_exenta (\r\n                                                            idFacturaLinea,\r\n                                                            folioFactura,\r\n                                                            fechaIngreso,\r\n                                                            codigo,\r\n                                                            descripcion,\r\n                                                            valorVenta,\r\n                                                            cantidad,\r\n                                                            porcentajeDescuentoLinea,\r\n                                                            descuentoLinea,\r\n                                                            subtotalLinea,\r\n                                                            totalLinea,\r\n                                                            tipoDescuento,\r\n                                                            listaPrecio,\r\n                                                            bodega,\r\n                                                            idImpuesto,\r\n                                                            netoLinea,\r\n                                                            descuentaInventario,\r\n                                                            valorCompra,\r\n                                                            usuario,\r\n                                                            stockQueda, exento\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactuLinea,\r\n                                                            @folioFacturaLinea,\r\n                                                            @fechaIngreso,\r\n                                                            @codigo,\r\n                                                            @descripcion,\r\n                                                            @valorVenta,\r\n                                                            @cantidad,\r\n                                                            @porcentajeDescuentoLinea,\r\n                                                            @descuentoLinea,\r\n                                                            @subtotalLinea,\r\n                                                            @totalLinea,\r\n                                                            @tipoDescuento,\r\n                                                            @listaPrecio,\r\n                                                            @bodega,\r\n                                                            @idImpuesto,\r\n                                                            @netoLinea,\r\n                                                            @descuentaInventario,\r\n                                                            @valorCompra,\r\n                                                            @usuario,\r\n                                                            @stockQueda, @exento\r\n                                                             )";
    ...
    public string UltimoFolio()
    {
        string ultimo = "";
        MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
        ((DbCommand)command).CommandText = "select last_insert_id(folio) as last from electronica_factura_exenta order by folio desc limit 1;";
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "INSERT INTO electronica_factura_exenta_referencias (\r\n                                                            idFactura,\r\n                                                            folioFactura,\r\n                                                            tipoDocumento,\r\n                                                            tipoDocumentoNombre,\r\n                                                            folioDocumentoReferencia,\r\n                                                            fechaDocumentoReferencia,\r\n                                                            tipoAccion,\r\n                                                            tipoAccionNombre,\r\n                                                            razonReferencia\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactura,\r\n                                                            @folioFactura,\r\n                                                            @tipoDocumento,\r\n                                                            @tipoDocumentoNombre,\r\n                                                            @folioDocumentoReferencia,\r\n                                                            @fechaDocumentoReferencia,\r\n                                                            @tipoAccion,\r\n                                                            @tipoAccionNombre,\r\n                                                            @razonReferencia\r\n                                                             )";
    ...
    public List<ReferenicaVO> buscaReferenciaIDFactura(int idFactura)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idReferencia, idFactura,\r\n                                                            folioFactura,\r\n                                                            tipoDocumento,\r\n                                                            tipoDocumentoNombre,\r\n                                                            folioDocumentoReferencia,\r\n                                                            fechaDocumentoReferencia,\r\n                                                            tipoAccion,\r\n                                                            tipoAccionNombre,\r\n                                                            razonReferencia\r\n                                                    FROM electronica_factura_exenta_referencias WHERE idFactura = @idFactura ORDER BY idReferencia asc";
    ...
    public bool facturaExiste(int numFactura)
    {
      bool flag = false;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT folio FROM electronica_factura_exenta WHERE folio=@numFactura";
    ...
    public int RetornaIdFactura(int numFactura)
    {
      int num = 0;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idfactura, folio FROM electronica_factura_exenta WHERE folio=@numFactura";
      command.Parameters.AddWithValue("@numFactura", (object) numFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
    ...
    public Venta buscaFacturaFolio(int numFactura)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idFactura,\r\n                                                            folio,\r\n                                                            fechaEmision,\r\n                                                            fechaVencimiento,\r\n                                                            idCliente,\r\n                                                            rut,\r\n                                                            digito,\r\n                                                            razonSocial,\r\n                                                            direccion,\r\n                                                            comuna,\r\n                                                            ciudad,\r\n                                                            giro,\r\n                                                            fono,\r\n                                                            fax, \r\n                                                            contacto,\r\n                                                            diasPlazo,\r\n                                                            idMedioPago,\r\n                                                            medioPago,\r\n                                                            idVendedor,\r\n                                                            vendedor,\r\n                                                            idCentroCosto,\r\n                                                            centroCosto,\r\n                                                            ordenCompra,\r\n                                                            subtotal,\r\n                                                            porcentajeDescuento, \r\n                                                            descuento,\r\n                                                            porcentajeIva,\r\n                                                            iva,\r\n                                                            neto,\r\n                                                            total, totalExento,\r\n                                                            totalPalabras,\r\n                                                            estadoPago,\r\n                                                            estadoDocumento,\r\n                                                            totalPagado,\r\n                                                            totalDocumentado,\r\n                                                            totalPendiente,\r\n                                                            impuesto1,\r\n                                                            impuesto2,\r\n                                                            impuesto3,\r\n                                                            impuesto4,\r\n                                                            impuesto5,\r\n                                                            porcentajeImpuesto1,\r\n                                                            porcentajeImpuesto2,\r\n                                                            porcentajeImpuesto3,\r\n                                                            porcentajeImpuesto4,\r\n                                                            porcentajeImpuesto5,\r\n                                                            idTicket,\r\n                                                            folioTicket,\r\n                                                            folioGuias,\r\n                                                            observaciones,\r\n                                                            idCotizacion,\r\n                                                            folioCotizacion,\r\n                                                            idNotaVenta,\r\n                                                            folioNotaVenta,\r\n                                                            folioOT, \r\n                                                            timbre,\r\n                                                            enviado_sii,\r\n                                                            enviado_libro,\r\n                                                            codImpuesto1,\r\n                                                            codImpuesto2,\r\n                                                            codImpuesto3,\r\n                                                            codImpuesto4,\r\n                                                            codImpuesto5     \r\n                                                FROM electronica_factura_exenta WHERE folio=@numFactura";
      command.Parameters.AddWithValue("@numFactura", (object) numFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
      {
    ...
    public List<DatosVentaVO> buscaDetalleFacturaIDFactura(int idFactura)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idDetalleFactura, \r\n                                                    idFacturaLinea,\r\n                                                    folioFactura,\r\n                                                    fechaIngreso,\r\n                                                    codigo,\r\n                                                    descripcion,\r\n                                                    valorVenta,\r\n                                                    cantidad,\r\n                                                    porcentajeDescuentoLinea,\r\n                                                    descuentoLinea,\r\n                                                    subtotalLinea,\r\n                                                    totalLinea,\r\n                                                    tipoDescuento,\r\n                                                    listaPrecio,\r\n                                                    bodega,\r\n                                                    idImpuesto,\r\n                                                    netoLinea,\r\n                                                    descuentaInventario,\r\n                                                    valorCompra,stockQueda, exento\r\n                                                    FROM electronica_detalle_factura_exenta WHERE idFacturaLinea = @idFactura ORDER BY idDetalleFactura asc";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
    ...
    public int numeroFactura(int caja)
    {
      int num = 0;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT MAX(folio)+1 FROM electronica_factura_exenta;"; //WHERE caja=@caja";
    ...
    public bool eliminaDetalleFactura(Venta veOB)
    {
      ...
      try
      {
        ((DbCommand) command).CommandText = "DELETE FROM electronica_detalle_factura_exenta WHERE idFacturaLinea=@idFactura AND folioFactura=@folioFactura";
        command.Parameters.AddWithValue("@idFactura", (object) veOB.IdFactura);
    ...
    public int eliminaFactura(int idFactura, List<DatosVentaVO> lista)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "DELETE electronica_factura_exenta, electronica_detalle_factura_exenta FROM electronica_factura_exenta, electronica_detalle_factura_exenta WHERE electronica_factura_exenta.idFactura = @idFactura AND electronica_detalle_factura_exenta.idFacturaLinea=@idFactura";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "UPDATE electronica_factura_exenta SET estadoDocumento = 'ANULADA', razonSocial= 'FACTURA ANULADA', rut='0', digito='0', subtotal='0', descuento='0', neto='0', iva='0',  total='0', impuesto1='0', impuesto2='0',impuesto3='0',impuesto4='0',impuesto5='0'  WHERE idFactura=@idFactura";
      command.Parameters.AddWithValue("@idFactura", (object) idFactura);
      ((DbCommand) command).ExecuteNonQuery();
      foreach (DatosVentaVO datosVentaVo in lista)
      {
