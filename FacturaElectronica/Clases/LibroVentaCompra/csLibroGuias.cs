...
// Type: Aptusoft.FacturaElectronica.Clases.LibroVentaCompra.csLibroGuias
...
{
  [XmlRoot(ElementName = "LibroGuia")]
  public class csLibroGuias
  {
    private string _rutaElectronica = "";
    private csEnvioLibroGuia _Envio = new csEnvioLibroGuia();

    public csEnvioLibroGuia EnvioLibro
    {
      get
      {
        return this._Envio;
    ...
    public string Serializar()
    {
      ...
      XmlWriter xmlWriter = XmlWriter.Create(this._rutaElectronica + "LIBROS\\GUIAS\\" + str + ".XML", settings);
