...
// Type: Aptusoft.FacturaElectronica.Clases.EBoleta
...
namespace Aptusoft.FacturaElectronica.Clases
{
  public class EBoleta
  {
    ...
    public string UltimoFolio()
    {
        string ultimo = "";
        MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
        ((DbCommand)command).CommandText = "select last_insert_id(folio) as last from electronica_boleta order by folio desc limit 1;";
    ...
    public bool agregaDetalleBoleta2(DatosVentaVO veVO)
    {
      ...
      if (num == 0)
        num = this.RetornaIdBoleta(veVO.FolioFactura);
      try
      {
        ((DbCommand) command).CommandText = "INSERT INTO electronica_detalle_boleta (\r\n                                                            idBoletaLinea,\r\n                                                            folioBoleta,\r\n                                                            fechaIngreso,\r\n                                                            codigo,\r\n                                                            descripcion,\r\n                                                            valorVenta,\r\n                                                            cantidad,\r\n                                                            porcentajeDescuentoLinea,\r\n                                                            descuentoLinea,\r\n                                                            subtotalLinea,\r\n                                                            totalLinea,\r\n                                                            tipoDescuento,\r\n                                                            listaPrecio,\r\n                                                            bodega,\r\n                                                            idImpuesto,\r\n                                                            netoLinea,\r\n                                                            descuentaInventario,\r\n                                                            valorCompra,\r\n                                                            usuario,\r\n                                                            stockQueda, exento\r\n                                                             ) \r\n                                                      VALUES(\r\n                                                            @idFactuLinea,\r\n                                                            @folioFacturaLinea,\r\n                                                            @fechaIngreso,\r\n                                                            @codigo,\r\n                                                            @descripcion,\r\n                                                            @valorVenta,\r\n                                                            @cantidad,\r\n                                                            @porcentajeDescuentoLinea,\r\n                                                            @descuentoLinea,\r\n                                                            @subtotalLinea,\r\n                                                            @totalLinea,\r\n                                                            @tipoDescuento,\r\n                                                            @listaPrecio,\r\n                                                            @bodega,\r\n                                                            @idImpuesto,\r\n                                                            @netoLinea,\r\n                                                            @descuentaInventario,\r\n                                                            @valorCompra,\r\n                                                            @usuario,\r\n                                                            @stockQueda, @exento\r\n                                                             )";
    ...
    public bool boletaExiste(int numBoleta)
    {
      bool flag = false;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT folio FROM electronica_boleta WHERE folio=@numFactura";
      command.Parameters.AddWithValue("@numFactura", (object) numBoleta);
      MySqlDataReader mySqlDataReader = command.ExecuteReader();
      while (((DbDataReader) mySqlDataReader).Read())
        flag = true;
      ((DbDataReader) mySqlDataReader).Close();
    ...
    public int RetornaIdBoleta(int numBoleta)
    {
        ...
        try
        {
            ...
            MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
            ((DbCommand)command).CommandText = "SELECT idBoleta, folio FROM electronica_boleta WHERE folio=@numBoleta";
    ...
    public List<DatosVentaVO> buscaDetalleBoletaIDBoleta(int idBoleta)
    {
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT idDetalleBoleta, \r\n                                                    idBoletaLinea,\r\n                                                    folioBoleta,\r\n                                                    fechaIngreso,\r\n                                                    codigo,\r\n                                                    descripcion,\r\n                                                    valorVenta,\r\n                                                    cantidad,\r\n                                                    porcentajeDescuentoLinea,\r\n                                                    descuentoLinea,\r\n                                                    subtotalLinea,\r\n                                                    totalLinea,\r\n                                                    tipoDescuento,\r\n                                                    listaPrecio,\r\n                                                    bodega,\r\n                                                    idImpuesto,\r\n                                                    netoLinea,\r\n                                                    descuentaInventario,\r\n                                                    valorCompra,stockQueda, exento\r\n                                                    FROM electronica_detalle_boleta WHERE idBoletaLinea = @idBoleta ORDER BY idDetalleBoleta asc";
    ...
    public int numeroBoleta(int caja)
    {
      int num = 0;
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand)command).CommandText = "SELECT MAX(folio)+1 FROM electronica_boleta;";// WHERE caja=@caja";
    ...
    public string modificaBoleta(Venta veOB, List<DatosVentaVO> listaNueva, List<LoteVO> listaLote, List<LoteVO> listaLoteAntigua)
    {
      ...
      try
      {
        ...
        {
          new ControlProducto().registroDocumentoModifica(datosVentaVo, "BOLETA ELECTRONICA");
          new ControlProducto().registroDocumentoModificaRetornaInventario(datosVentaVo, "BOLETA ELECTRONICA");
    ...
    public bool eliminaDetalleBoleta(Venta veOB)
    {
      ...
      try
      {
        ((DbCommand) command).CommandText = "DELETE FROM electronica_detalle_boleta WHERE idBoletaLinea=@idBoleta AND folioBoleta=@folioBoleta";
        command.Parameters.AddWithValue("@idBoleta", (object) veOB.IdFactura);
    ...
    public int eliminaBoleta(int idBoleta, List<DatosVentaVO> lista, List<LoteVO> listaLoteAntigua)
    {
      foreach (DatosVentaVO datosVentaVo in lista)
      {
        if (datosVentaVo.DescuentaInventario)
        {
          new ControlProducto().registroDocumentoNulo(datosVentaVo, "BOLETA ELECTRONICA");
          this.actualizaStock(datosVentaVo, "+");
        }
      }
      if (listaLoteAntigua.Count > 0)
      ...
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "DELETE electronica_boleta, electronica_detalle_boleta FROM electronica_boleta, electronica_detalle_boleta WHERE electronica_boleta.idBoleta = @idBoleta AND electronica_detalle_boleta.idBoletaLinea=@idBoleta";
      command.Parameters.AddWithValue("@idBoleta", (object) idBoleta);
    ...
    {
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "UPDATE electronica_boleta SET estadoDocumento = 'ANULADA', razonSocial= 'BOLETA ANULADA', rut='0', digito='0', subtotal='0', descuento='0', neto='0', iva='0',  total='0', impuesto1='0', impuesto2='0',impuesto3='0',impuesto4='0',impuesto5='0'  WHERE idBoleta=@idBoleta";
      command.Parameters.AddWithValue("@idBoleta", (object) idBoleta);
      ((DbCommand) command).ExecuteNonQuery();
      foreach (DatosVentaVO datosVentaVo in lista)
      {
    ...
    private void registroBoletaNula(DatosVentaVO vevo)
    {
      ...
      cp.Movimiento = "ANULA BOLETA ELECTRONICA FOLIO: " + (object) vevo.FolioFactura;
    ...
    public DataTable boletaElectronicaInforme(string filtro)
    {
    ...
    public DataTable boletaElectronicaInformeDetalle(string filtro)
    {
      string str = "SELECT \r\n                            f.idBoleta,\r\n                            f.folio,\r\n                            f.fechaEmision,\r\n                            f.fechaVencimiento,\r\n                            f.dia,\r\n                            f.mes,\r\n                            f.ano,\r\n                            f.idCliente, \r\n                            f.rut, \r\n                            f.digito, \r\n                            f.razonSocial,\r\n                            f.direccion, \r\n                            f.comuna, \r\n                            f.ciudad, \r\n                            f.giro, \r\n                            f.fono, \r\n                            f.fax, \r\n                            f.contacto, \r\n                            f.diasPlazo, \r\n                            f.idMedioPago,                          \r\n                            f.medioPago, \r\n                            f.idVendedor, \r\n                            f.vendedor, \r\n                            f.idCentroCosto, \r\n                            f.centroCosto, \r\n                            f.ordenCompra, \r\n                            f.subtotal, \r\n                            f.porcentajeDescuento,\r\n                            f.descuento, \r\n                            f.porcentajeIva, \r\n                            f.iva,\r\n                            f.neto, \r\n                            f.total, \r\n                            f.totalExento,\r\n                            f.totalPalabras, \r\n                            f.estadoPago, \r\n                            f.estadoDocumento, \r\n                            f.totalPagado,\r\n                            f.totalDocumentado,\r\n                            f.totalPendiente,\r\n                            f.impuesto1,\r\n                            f.impuesto2,\r\n                            f.impuesto3,\r\n                            f.impuesto4,\r\n                            f.impuesto5,\r\n                            f.porcentajeImpuesto1,\r\n                            f.porcentajeImpuesto2,\r\n                            f.porcentajeImpuesto3,\r\n                            f.porcentajeImpuesto4,\r\n                            f.porcentajeImpuesto5,\r\n                            f.comisionVendedor,\r\n                            f.idTicket,\r\n                            f.folioTicket,\r\n                            f.folioGuias,\r\n                            f.observaciones,\r\n                            f.fechaModificacion,\r\n                            f.idCotizacion,\r\n                            f.folioCotizacion,\r\n                            f.caja,\r\n                            f.idNotaVenta,\r\n                            f.folioNotaVenta,\r\n                            f.tipoDocumento1,\r\n                            f.tipoDocumento2,\r\n                            f.tipoDocumento3,\r\n                            f.tipoDocumento4,\r\n                            f.tipoDocumento5,\r\n                            f.tipoDocumentoNombre1,\r\n                            f.tipoDocumentoNombre2,\r\n                            f.tipoDocumentoNombre3,\r\n                            f.tipoDocumentoNombre4,\r\n                            f.tipoDocumentoNombre5,\r\n                            f.folioDocumentoReferencia1,\r\n                            f.folioDocumentoReferencia2,\r\n                            f.folioDocumentoReferencia3,\r\n                            f.folioDocumentoReferencia4,\r\n                            f.folioDocumentoReferencia5,\r\n                            f.fechaDocumentoReferencia1,\r\n                            f.fechaDocumentoReferencia2,\r\n                            f.fechaDocumentoReferencia3,\r\n                            f.fechaDocumentoReferencia4,\r\n                            f.fechaDocumentoReferencia5,\r\n                            f.tipoAccion1,\r\n                            f.tipoAccion2,\r\n                            f.tipoAccion3,\r\n                            f.tipoAccion4,\r\n                            f.tipoAccion5,\r\n                            f.tipoAccionNombre1,\r\n                            f.tipoAccionNombre2,\r\n                            f.tipoAccionNombre3,\r\n                            f.tipoAccionNombre4,\r\n                            f.tipoAccionNombre5,\r\n                            f.razonReferencia1,\r\n                            f.razonReferencia2,\r\n                            f.razonReferencia3,\r\n                            f.razonReferencia4,\r\n                            f.razonReferencia5,\r\n                            f.codImpuesto1,\r\n                            f.codImpuesto2,\r\n                            f.codImpuesto3,\r\n                            f.codImpuesto4,\r\n                            f.codImpuesto5,\r\n                            d.idBoletaLinea,\r\n                            d.folioBoleta,\r\n                            d.fechaIngreso,\r\n                            d.codigo,\r\n                            d.descripcion,\r\n                            d.valorVenta,\r\n                            d.cantidad,\r\n                            d.porcentajeDescuentoLinea,\r\n                            d.descuentoLinea,\r\n                            d.subtotalLinea, \r\n                            d.totalLinea, \r\n                            d.tipoDescuento, \r\n                            d.listaPrecio, \r\n                            d.bodega, \r\n                            d.idDetalleBoleta,                            \r\n                            d.idImpuesto, \r\n                            d.netoLinea,\r\n                            d.valorCompra,\r\n                            d.exento\r\n                            FROM electronica_boleta f INNER JOIN electronica_detalle_boleta d\r\n                            ON f.idBoleta = d.idBoletaLinea                                                        \r\n                            WHERE " + filtro + " ORDER BY f.folio";
      DataTable dataTable = new DataTable();
      try
      {
        MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
    ...
    public DataTable boletaElectronicaInformeProductoCategoria(string filtro)
    {
      DataTable dataTable = new DataTable();
      MySqlCommand command = this.conexion.ConexionMySql.CreateCommand();
      ((DbCommand) command).CommandText = "SELECT f.folio, f.fechaEmision,\r\n                                            f.idCentroCosto,\r\n                                            f.centroCosto,\r\n                                            d.codigo,\r\n                                            d.descripcion,\r\n                                            d.cantidad,\r\n                                            d.valorVenta,\r\n                                            d.totalLinea,\r\n                                            p.Categoria\r\n                                    FROM electronica_boleta f \r\n                                    INNER JOIN electronica_detalle_boleta d \r\n                                    ON f.idBoleta=d.idBoletaLinea\r\n                                    LEFT JOIN productos p\r\n                                    ON p.codigo=d.codigo\r\n                                    WHERE " + filtro;
      ((DbDataAdapter) new MySqlDataAdapter(command)).Fill(dataTable);
      return dataTable;
    }
  }
