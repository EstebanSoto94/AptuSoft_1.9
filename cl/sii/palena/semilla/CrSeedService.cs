...
// Type: Aptusoft.cl.sii.palena.semilla.CrSeedService
...
namespace Aptusoft.cl.sii.palena.semilla
{
  ...
  [WebServiceBinding(Name = "CrSeedSoapBinding", Namespace = "https://palena.sii.cl/DTEWS/CrSeed.jws")]
  ...
  public class CrSeedService : SoapHttpClientProtocol
  {
    ...
    {
      this.Url = Settings.Default.Aptusoft_cl_sii_palena_semilla_CrSeedService;
