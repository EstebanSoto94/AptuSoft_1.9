...
// Type: Aptusoft.cl.sii.palena.consultaDTE.QueryEstDteService
...
{
  [WebServiceBinding(Name = "QueryEstDteSoapBinding", Namespace = "https://palena.sii.cl/DTEWS/QueryEstDte.jws")]
  ...
  public class QueryEstDteService : SoapHttpClientProtocol
  {
    ...
    {
      this.Url = Settings.Default.Aptusoft_cl_sii_palena_consultaDTE_QueryEstDteService;
    ...
    [SoapRpcMethod("", RequestNamespace = "http://DefaultNamespace", ResponseNamespace = "https://palena.sii.cl/DTEWS/QueryEstDte.jws")]
