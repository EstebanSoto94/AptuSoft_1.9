...
// Type: Aptusoft.cl.sii.maullin.token.GetTokenFromSeedService
...
namespace Aptusoft.cl.sii.maullin.token
{
  ...
  [WebServiceBinding(Name = "GetTokenFromSeedSoapBinding", Namespace = "https://maullin.sii.cl/DTEWS/GetTokenFromSeed.jws")]
  ...
  public class GetTokenFromSeedService : SoapHttpClientProtocol
  {
    ...
    {
      this.Url = Settings.Default.Aptusoft_cl_sii_maullin_token_GetTokenFromSeedService;
    ...
    [SoapRpcMethod("", RequestNamespace = "http://DefaultNamespace", ResponseNamespace = "https://maullin.sii.cl/DTEWS/GetTokenFromSeed.jws")]
