...
// Type: Aptusoft.cl.sii.maullin.consulta.QueryEstUpService
...
namespace Aptusoft.cl.sii.maullin.consulta
{
  ...
  [WebServiceBinding(Name = "QueryEstUpSoapBinding", Namespace = "https://maullin.sii.cl/DTEWS/QueryEstUp.jws")]
  public class QueryEstUpService : SoapHttpClientProtocol
  {
    ...
    {
      this.Url = Settings.Default.Aptusoft_cl_sii_maullin_consulta_QueryEstUpService;
    ...
    [SoapRpcMethod("", RequestNamespace = "http://DefaultNamespace", ResponseNamespace = "https://maullin.sii.cl/DTEWS/QueryEstUp.jws")]
