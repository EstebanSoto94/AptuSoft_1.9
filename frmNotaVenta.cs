...
namespace Aptusoft
{
  public class frmNotaVenta : Form
  {
    ...
    private Venta veOBNotaVenta = new Venta();
    private IContainer components = (IContainer) null;
    private frmNotaVenta intance;
    ...
    private void cargaPermisos()
    {
      ...
      {
        if (usuarioVo.Modulo.Equals("NOTA VENTA"))
        {
    ...
    {
      this.odVO = new OpcionesGenerales().rescataOpcionesDocumentosPorNombre("NOTA_VENTA");
    ...
    private void obtieneFolioNotaVentaDisponible()
    {
      this.txtNumeroDocumento.Text = new NotaVenta().numeroNotaVenta(this._caja).ToString();
    }

    private void obtieneFolioNotaVentaDisponibleSinCaja()
    {
      this.txtNumeroDocumento.Text = new NotaVenta().numeroNotaVentaSinCaja().ToString();
    }
    ...
    public void iniciaVenta()
    {
      ...
      try
      {
        this.obtieneFolioNotaVentaDisponible();
    ...
    {
      frmMenuPrincipal._modNotaVenta = 0;
      this.Dispose();
      this.Close();
    }
    ...
    public void llamaProductoCodigo(string cod, int bodega)
    {
      ...
      if (productoVo.Codigo != null)
      {
        ...
        if (this.alertaStock.Equals("1"))
        {
          ...
          {
            int num = (int) MessageBox.Show("No Hay Stock Suficiente", "Stock Insuficiente", MessageBoxButtons.OK, MessageBoxIcon.Hand);
        ...
        if (this.lista.Count < Convert.ToInt32(this.numeroLineas))
        {
          if (this.lista.Count > 0)
          {
            ...
            for (int index = 0; index < this.lista.Count; ++index)
            {
              ...
              {
                if (datosVentaVo.Cantidad + this.lista[index].Cantidad > this.stock && this.impideVentasSinStock.Equals("1"))
                {
    ...
    private void buscaCliente()
    {
      ...
      if (cli.Count > 1)
      {
        ...
        int num = (int) new frmClienteMismoRut(cli, ref this.intance, "nota_venta").ShowDialog();
      }
      else if (cli.Count == 0)
      {
    ...
    {
      int num = (int) new frmBuscaClientes(ref this.intance, "nota_venta").ShowDialog();
    }
    ...
    private void guardaNotaVenta()
    {
      ...
      if (this.hayTicket)
      {
        veOB.FolioTicket = this.veOBNotaVenta.Folio;
        veOB.IdTicket = this.idNotaVenta;
      }
      else
      {
        veOB.FolioTicket = 0;
      ...
      {
        veOB.FolioCotizacion = this.veOBNotaVenta.Folio;
        veOB.IdCotizacion = this.idNotaVenta;
      }
      else
      {
      ...
      if (notaVenta.notaVentaExiste(Convert.ToInt32(this.txtNumeroDocumento.Text.Trim())))
      {
        this.obtieneFolioNotaVentaDisponible();
        if (this.txtNumeroDocumento.Text.Trim() == "1")
          this.obtieneFolioNotaVentaDisponibleSinCaja();
      }
      ...
      notaVenta.agregaNotaVenta(veOB);
      notaVenta.agregaDetalleNotaVenta(this.lista, this._listaLote);
      this.cambiaEstadoTicket();
      this.cambiaEstadoCotizacion();
      this.imprimeNotaVenta(Convert.ToInt32(this.txtNumeroDocumento.Text));
    }

    private void imprimeNotaVenta(int folio)
    {
      if (MessageBox.Show("Desea Imprimir la Nota de Venta?", "Alerta", MessageBoxButtons.YesNo) == DialogResult.Yes)
        this.imprimeDirecto();
      else
        this.iniciaVenta();
    }
    ...
    private void cambiaEstadoTicket()
    {
      ...
      string str = "NOTA VENTA";
      this.veOBNotaVenta.FolioDocumentoVenta = Convert.ToInt32(this.txtNumeroDocumento.Text.Trim());
      this.veOBNotaVenta.IDDocumentoVenta = new NotaVenta().RetornaIdNotaVenta(this.veOBNotaVenta.FolioDocumentoVenta);
      this.veOBNotaVenta.DocumentoVenta = str;
      ticket.modificaTipoDocumentoTicket(this.veOBNotaVenta);
    }

    private void cambiaEstadoTicketEliminaNotaVenta()
    {
      if (!this.hayTicket)
        return;
      Ticket ticket = new Ticket();
      this.veOBNotaVenta.FolioDocumentoVenta = Convert.ToInt32(this.txtNumeroDocumento.Text.Trim());
      this.veOBNotaVenta.IDDocumentoVenta = 0;
      this.veOBNotaVenta.FolioDocumentoVenta = 0;
      this.veOBNotaVenta.DocumentoVenta = "";
      this.veOBNotaVenta.IdFactura = this.veOBNotaVenta.IdTicket;
      this.veOBNotaVenta.Folio = this.veOBNotaVenta.FolioTicket;
      int num = (int) MessageBox.Show(ticket.modificaTipoDocumentoTicket(this.veOBNotaVenta).ToString());
    }
    ...
    {
      if (MessageBox.Show("Esta Seguro de Modificar la Nota de Venta ", "Alerta", MessageBoxButtons.YesNo) == DialogResult.Yes)
      {
        if (!this.validaCampos())
          return;
        Venta veOB = new Venta();
        veOB.IdFactura = this.idNotaVenta;
        veOB.Folio = Convert.ToInt32(this.txtNumeroDocumento.Text.Trim());
        DateTime dateTime1 =DateTime.Now;
        // ISSUE: explicit reference operation
        // ISSUE: variable of a reference type
        ...
        int num2 = (int) MessageBox.Show(notaVenta.modificaNotaVenta(veOB, this.lista, this._listaLote, this._listaLoteAntigua));
        this.imprimeNotaVenta(veOB.Folio);
      }
      else
      {
        int num = (int) MessageBox.Show("La Nota de Venta NO fue Modificada.");
        this.iniciaVenta();
      }
    }
    ...
    private void frmFactura_KeyDown(object sender, KeyEventArgs e)
    {
      ...
      {
        this.txtCodigo.Focus();
        int num = (int) new frmBuscaProductos("nota_venta", ref this.intance, this.cmbBodega.Text.Trim(), Convert.ToInt32(this.cmbBodega.SelectedValue), this._modBodega, this.decimalesValoresVenta).ShowDialog();
        this.txtCantidad.Focus();
      }
      ...
      if (this._guarda && this.veOBNotaVenta.IdFactura == 0 && e.KeyCode == Keys.F2)
        this.guardaNotaVenta();
      if (e.KeyCode != Keys.F5)
        return;
      int num1 = (int) new frmVuelto(this.txtTotalGeneral.Text, ref this.intance, "nota_venta").ShowDialog();
    }
    ...
    private void buscaNotaVentaFolio()
    {
      this.panelFolio.Visible = false;
      NotaVenta notaVenta = new NotaVenta();
      Venta venta = notaVenta.buscaNotaVentaFolio(Convert.ToInt32(this.txtFolioBuscar.Text.Trim()));
      this.veOBNotaVenta = venta;
      if (venta.IdFactura != 0)
      {
        this.iniciaVenta();
        this.cambiarNumeroDeFolioToolStripMenuItem.Enabled = false;
        this.idNotaVenta = venta.IdFactura;
        ...
        num2 = venta.Total;
        string str8 = num2.ToString("N" + this.decimalesValoresVenta);
        textBox8.Text = str8;
        ...
        {
          this.hayTicket = true;
          TextBox textBox14 = this.txtTicket;
        ...
        this.dgvDatosVenta.DataSource = (object) this.lista;
        this._listaLote.Clear();
        this._listaLote = new Lote().ListaLotePorDocumento("VENTA", "NOTA DE VENTA", venta.IdFactura);
        this._listaLoteAntigua.Clear();
      ...
      {
        int num = (int) MessageBox.Show("No Existe Nota de Venta Consultada!!", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        this.txtFolioBuscar.Clear();
        this.iniciaVenta();
      }
    }
    ...
    private void btnAnular_Click(object sender, EventArgs e)
    {
      ...
      {
        if (MessageBox.Show("Esta seguro de Anular esta Nota de Venta. Los productos seran retornados a Bodega", "Alerta", MessageBoxButtons.YesNo) == DialogResult.Yes)
        {
          NotaVenta notaVenta = new NotaVenta();
          try
          {
            string text = notaVenta.anulaNotaVenta(this.idNotaVenta, this.lista, this._listaLoteAntigua);
            if (this.hayTicket)
              this.cambiaEstadoTicketEliminaNotaVenta();
            if (this.hayCotizacion)
              this.cambiaEstadoCotizacionEliminaNotaVenta();
        ...
        {
          int num = (int) MessageBox.Show("La Nota de Venta NO fue Anulada..");
          this.iniciaVenta();
        }
      }
      else
    ...
    private void btnEliminar_Click(object sender, EventArgs e)
    {
      if (!this.lblEstadoDocumento.Text.Equals("ANULADA"))
        return;
      if (MessageBox.Show("Esta seguro de Eliminar esta Nota de Venta.", "Alerta", MessageBoxButtons.YesNo) == DialogResult.Yes)
      {
        NotaVenta notaVenta = new NotaVenta();
        try
        {
          notaVenta.eliminaNotaVenta(this.idNotaVenta);
          int num = (int) MessageBox.Show("Nota de Venta Eliminada");
          this.iniciaVenta();
        }
        catch (Exception ex)
        {
      ...
      {
        int num = (int) MessageBox.Show("La Nota de Venta NO fue Eliminada ");
        this.iniciaVenta();
      }
    }
    ...
    {
      DataTable dataTable = new NotaVenta().muestraNotaVentaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
      LeeXml leeXml = new LeeXml();
      ArrayList arrayList1 = new ArrayList();
      ArrayList arrayList2 = leeXml.cargarDatosMultiEmpresa("nota_venta");
      arrayList2[0].ToString();
      string str = arrayList2[1].ToString();
      ReportDocument rpt = new ReportDocument();
      rpt.Load("C:\\AptuSoft\\reportes\\NotaVenta_" + str + ".rpt");
    ...
    private void monoEmpresa()
    {
      DataTable dataTable = new NotaVenta().muestraNotaVentaFolio(Convert.ToInt32(this.txtNumeroDocumento.Text));
      ReportDocument rpt = new ReportDocument();
      rpt.Load("C:\\AptuSoft\\reportes\\NotaVenta.rpt");
      rpt.SetDataSource(dataTable);
      int num = (int) new frmVisualizadorReportes(rpt).ShowDialog();
      this.iniciaVenta();
    }
    ...
    {
      int num = (int) MessageBox.Show(this.veOBNotaVenta.RazonSocial);
    }
      ...
      try
      {
        ...
        if (venta.IdFactura != 0)
        {
          if (venta.IDDocumentoVenta == 0)
          {
            ...
            this.txtNeto.Text = venta.Neto.ToString("N" + this.decimalesValoresVenta);
            TextBox textBox1 = this.txtIva;
            Decimal num = venta.Iva;
    ...
    private void cambiaEstadoCotizacion()
    {
      ...
      this.veOBNotaVenta.IDDocumentoVenta = new NotaVenta().RetornaIdNotaVenta(this.veOBNotaVenta.FolioDocumentoVenta);
      this.veOBNotaVenta.DocumentoVenta = str;
      cotizacion.modificaTipoDocumentoCotizacion(this.veOBNotaVenta);
    }

    private void cambiaEstadoCotizacionEliminaNotaVenta()
    {
      if (!this.hayCotizacion)
        return;
      Cotizacion cotizacion = new Cotizacion();
      ...
      this.veOBNotaVenta.FolioDocumentoVenta = 0;
      this.veOBNotaVenta.DocumentoVenta = "";
      this.veOBNotaVenta.IdFactura = this.veOBNotaVenta.IdCotizacion;
      this.veOBNotaVenta.Folio = this.veOBNotaVenta.FolioCotizacion;
      cotizacion.modificaTipoDocumentoCotizacion(this.veOBNotaVenta);
    }
    ...
    {
      int num = (int) new frmVuelto(this.txtTotalGeneral.Text, ref this.intance, "nota_venta").ShowDialog();
    }
    ...
    private void InitializeComponent()
    {
            ...
            this.buscarProductosTeclaF4ToolStripMenuItem.Size = new System.Drawing.Size(234, 22);
            ...
            this.buscarFacturaTeclaF6ToolStripMenuItem.Size = new System.Drawing.Size(234, 22);
            this.buscarFacturaTeclaF6ToolStripMenuItem.Text = "Buscar Nota Venta - tecla [F6]";
            ...
            this.guardarFacturaTeclaF2ToolStripMenuItem.Size = new System.Drawing.Size(234, 22);
            this.guardarFacturaTeclaF2ToolStripMenuItem.Text = "Guardar Nota Venta - tecla[F2]";
            ...
            this.cambiarNumeroDeFolioToolStripMenuItem.Size = new System.Drawing.Size(234, 22);
            ...
            this.calculaVueltoTeclaF5ToolStripMenuItem.Size = new System.Drawing.Size(234, 22);
            ...
            this.lblFolio.Size = new System.Drawing.Size(105, 16);
            this.lblFolio.TabIndex = 5;
            this.lblFolio.Text = "Nota Venta N°";
            ...
            this.gbZonaBotones.Location = new System.Drawing.Point(10, 446);
            ...
            this.chkExento.Location = new System.Drawing.Point(690, 11);
            this.chkExento.Name = "chkExento";
            this.chkExento.Size = new System.Drawing.Size(187, 20);
            this.chkExento.TabIndex = 31;
            this.chkExento.Text = "Nota de Venta Exenta";
            ...
            this.lblTipoDoc.Font = new System.Drawing.Font("Microsoft Sans Serif", 15.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblTipoDoc.ForeColor = System.Drawing.Color.Red;
            this.lblTipoDoc.Location = new System.Drawing.Point(16, 50);
            this.lblTipoDoc.Name = "lblTipoDoc";
            this.lblTipoDoc.Size = new System.Drawing.Size(19, 25);
            ...
            this.label3.Text = "NOTA VENTA";
            this.label3.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // btnImprime
            // 
            this.btnImprime.Location = new System.Drawing.Point(96, 113);
            ...
            this.lblEstadoDocumento.Location = new System.Drawing.Point(214, 16);
            ...
            // btnAnular
            // 
            this.btnAnular.Location = new System.Drawing.Point(185, 87);
            ...
            this.btnSalir.Location = new System.Drawing.Point(274, 113);
            ...
            this.txtPorIva.Location = new System.Drawing.Point(774, 99);
            ...
            // btnLimpiar
            // 
            this.btnLimpiar.Location = new System.Drawing.Point(185, 113);
            ...
            // btnGuardar
            // 
            this.btnGuardar.Location = new System.Drawing.Point(7, 87);
            ...
            // btnEliminar
            // 
            this.btnEliminar.Location = new System.Drawing.Point(274, 87);
            ...
            // btnModificar
            // 
            this.btnModificar.Location = new System.Drawing.Point(96, 87);
            ...
            this.txtSubTotal.Location = new System.Drawing.Point(774, 33);
            ...
            this.txtTotalGeneral.Location = new System.Drawing.Point(774, 121);
            ...
            this.txtIva.Location = new System.Drawing.Point(800, 99);
            ...
            this.txtNeto.Location = new System.Drawing.Point(774, 77);
            ...
            this.txtTotalDescuento.Location = new System.Drawing.Point(800, 55);
            ...
            this.txtPorcDescuentoTotal.Location = new System.Drawing.Point(774, 55);
            ...
            this.label26.Location = new System.Drawing.Point(723, 125);
            ...
            this.label25.Location = new System.Drawing.Point(735, 103);
            ...
            this.label24.Location = new System.Drawing.Point(729, 81);
            ...
            this.label23.Location = new System.Drawing.Point(687, 59);
            ...
            this.label22.Location = new System.Drawing.Point(698, 37);
            ...
            this.panelFolio.Location = new System.Drawing.Point(703, 73);
            this.panelFolio.Name = "panelFolio";
            this.panelFolio.Size = new System.Drawing.Size(228, 92);
            ...
            this.gbZonaTicket.Size = new System.Drawing.Size(121, 155);
            ...
            this.btnBuscaCotizacion.Location = new System.Drawing.Point(98, 88);
            this.btnBuscaCotizacion.Name = "btnBuscaCotizacion";
            this.btnBuscaCotizacion.Size = new System.Drawing.Size(75, 23);
            ...
            // txtFolioCotizacion
            // 
            this.txtFolioCotizacion.Location = new System.Drawing.Point(72, 51);
            this.txtFolioCotizacion.Name = "txtFolioCotizacion";
            this.txtFolioCotizacion.Size = new System.Drawing.Size(129, 20);
            ...
            this.label36.Location = new System.Drawing.Point(19, 30);
            this.label36.Name = "label36";
            this.label36.Size = new System.Drawing.Size(233, 54);
            this.label36.TabIndex = 0;
            this.label36.Text = "INGRESE FOLIO DE COTIZACIÓN";
            ...
            this.btnSalirBuscaCoti.Location = new System.Drawing.Point(245, 3);
            ...
            // pnlCotizacionBuscar
            // 
            this.pnlCotizacionBuscar.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
            ...
            this.pnlCotizacionBuscar.Location = new System.Drawing.Point(341, 160);
            this.pnlCotizacionBuscar.Name = "pnlCotizacionBuscar";
            this.pnlCotizacionBuscar.Size = new System.Drawing.Size(279, 119);
